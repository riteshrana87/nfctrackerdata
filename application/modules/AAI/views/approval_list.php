        ...
        <h1 class="page-title">
            ...
            <div class="pull-right for-tab">
                <div class="btn-group">
                    ...
                    <a href="<?=base_url('AAI/view/'.$incident_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Return To Current AAI
                    </a>
            ...
            <div class="col-md-12">
                <div class="panel panel-default tile tile-profile">
                    <div class="panel-body">
                        ...
                        <h2>Accident And Incident Record </h2>
        ...
        <h1 class="page-title">
            <div class="col-xs-12">
                <div class="pull-right btn-section">
                    <div class="btn-group">
                    <a href="<?=base_url('YoungPerson/view/'.$YP_details[0]['care_home'])?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default"><i class="fa fa-mail-reply"></i> CARE HOME YP LIST</a>
                    <a href="<?=base_url('AAI/view/'.$incident_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Return To Current AAI
                    </a>
                    <a href="<?=base_url('YoungPerson/view/'.$ypid); ?>" class="btn btn-default">
