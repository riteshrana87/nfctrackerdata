            ...
            <div class="sticky-heading" id="sticky-heading">
                <h1 class="page-title">
                    ...
                    <div class="pull-right for-tab">
                        <div class="btn-group">
                            <a href="<?= base_url('AAI/signoffData/' . $ypId . '/' . $signoff_approval_id .'/'. $key_data .'/pdf'); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Generate PDF </a>
                        </div>
                    </div>
                </h1>
                <h1 class="page-title">
                ...
                <div class="multi_step_form">
                    <div id="msform">
                        ...
                        <?php }else{ ?>     
                          ...
                          <?php if(!empty($user_signoff) && $user_signoff == 1){ ?>
                <div class="col-sm-12">
                    <div class="panel panel-default tile tile-profile">
                        ...
                        <div class="panel-body">
                            <h2>User sign off</h2>
                                    ...
                                    <input type="checkbox" onclick="signoff_request(<?php echo $ypId .','. $signoff_approval_id; ?>);" name="signoff_data" class="" value="active">
                        </div>
                    </div>
                </div>
                <?php } ?>
