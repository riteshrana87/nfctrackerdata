                    ...
                    if (!empty($l2_form_data)) {
                        foreach ($l2_form_data as $row) {
                            ...
                            if ($row['type'] == 'textarea') {?>
                                <div class="col-md-6" id="div_<?=$row['name']?>">
                                    <div class="form-group">
                        ...
                        ?>
                        <div class="col-md-4" id="div_<?=$row['name']?>">
                            <div class="form-group">
                             <h2 class="aai-header-title col-md-12"><?=!empty($row['label']) ? $row['label'] : ''?> <?=!empty($row['required']) ? '<span class="astrick">*</span>' : ''?></h2>
...
<?php if ($row['name'] == 'total_time_not_pi') {
    ...
    <div class="col-md-12">
        <div class="form-group">
            <h2 class="aai-header-title col-md-12">Medical Observations</h2>
        </div>
    </div>


    <div class="col-md-12 clear-div-flex" id="add_medical_observation">
        <?php if (!empty($l2medical_observations)) {
            $med = 1;
            foreach ($l2medical_observations as $value) {
                ?>
                <div class="col-md-6 dynamic-div" id="item_new_medical_observation_<?php echo $med; ?>">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="radio-group">
                                <div class="radio-inline ">
                                    <label>
                                        <input <?=(isset($value['l2_medical_observation_taken' . $med]) && $value['l2_medical_observation_taken' . $med] == 'Yes') ? 'checked="checked"' : ''?> name="l2_medical_observation_taken<?php echo $med; ?>" class="" value="Yes" type="radio" data-parsley-multiple="l2_sanction_required">
                                    Yes</label>
                                </div>
                                <div class="radio-inline">
                                    <label><input <?=(isset($value['l2_medical_observation_taken' . $med]) && $value['l2_medical_observation_taken' . $med] == 'No') ? 'checked="checked"' : ''?> name="l2_medical_observation_taken<?php echo $med; ?>" class="" value="No" type="radio" data-parsley-multiple="l2_sanction_required">
                                    No</label>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 m-t-3"> <div class="input-group input-append bootstrap-timepicker">
                            <input type="text" class="red form-control aaiaddtime addtime_data timer-sty" name="l2medical_observations_after_minutes[]" id="time_safeguard<?php echo $med; ?>" placeholder="" value="<?=!empty($value['l2medical_observations_after_minutes']) ? $value['l2medical_observations_after_minutes'] : ''?>" data-parsley-errors-container="#errors-containertime_event" readonly="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 m-t-3"> <div class="input-group input-append bootstrap-timepicker">
                        <input type="text" class="red form-control aaiaddtime addtime_data timer-sty" name="l2time_medical[]" id="medical_observations_time_safeguard<?php echo $med ?>" placeholder="" value="<?=!empty($value['l2time_medical']) ? $value['l2time_medical'] : ''?>" data-parsley-errors-container="#errors-containertime_event" readonly="">
            ...
            <div class="form-group m-t-3">
                ...
                <div class="col-md-6">
                    <select data-parsley-errors-container="#errors-1" class="form-control chosen-select" id="1" name="l2Observation_taken_by<?php echo $med; ?>[]">

                       <option value=''> Select user </option>

                       <?php if (!empty($bambooNfcUsers)) {
                        foreach ($bambooNfcUsers as $select) {?>
                            <option value="<?php echo $select['user_type'] . '_' . $select['user_id']; ?>" <?php if (isset($value['l2Observation_taken_by' . $med][0]) && ($value['l2Observation_taken_by' . $med][0] == $select['user_type'] . '_' . $select['user_id'])) {echo 'selected="true"';}?>> <?php echo $select['first_name'] . ' ' . $select['last_name'] . ' - ' . $select['email']; ?> </option>
                        <?php }}?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 m-t-3">
                    <textarea id="what_happned" class="form-control timer-sty"  placeholder="Daily action outcome" name="l2comments_mo[]"><?=!empty($value['l2comments_mo']) ? $value['l2comments_mo'] : ''?></textarea>
                </div>
            </div>
...
<div class=" section_seven text-center mb30 col-md-12">
    ...
    <a id="l2add_new_medical_observations" class="btn btn-default" href="javascript:;">
...
<?php
    ...
    ?>
    <div class="col-md-12 radio-select-btn" id="div_<?=$row['name']?>">
        <div class="form-group">
        ...
        <?php if ($row['name'] == 'l2_sanction_required') {
          ...
          <div class="col-md-12 clear-div-flex" id="l2add_sequence_of_events">
            <?php if (!empty($l2sequence_events)) {
                ...
                foreach ($l2sequence_events as $value) { 
                   ...
                   ?>
                   <div class="col-md-6 dynamic-div" id="l2item_new_sequence_<?php echo $se; ?>">
                    <div class="form-group">
                        <div class="col-md-6"><label class="sds">Sequence Number</label></div>
                        <div class="col-md-6">
                                                                        <?php /* ?><input name="l2sequence_number[]" class="red form-control input-textar-style" value="<?=!empty($value['l2sequence_number']) ? $value['l2sequence_number'] : 'S' . $se?>" type="text" />
                                                                        <?php */ ?>
                                                                ...
                                                                <div class="form-group m-t-3">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <select multiple data-parsley-errors-container="#errors-1" class="form-control chosen-select l2Who_was_involved_in_incident<?php echo $se; ?> cred" id="1" name="l2Who_was_involved_in_incident<?php echo $se; ?>[]">
                                                                           <option value=''> Select user </option>
                                                                           <?php $value_who = $value['l2Who_was_involved_in_incident' . $seq_datal2];?>
                                                                           <?php if (!empty($bambooNfcUsers)) {
                                                                            foreach ($bambooNfcUsers as $select) { ?>
                                                                ...
                                                                <select data-parsley-errors-container="#errors-1" class="form-control chosen-select" id="1" name="l2position[]">
                                                                   ...
                                                                   <?php if (!empty($position_of_yp)) {
                                                                    foreach ($position_of_yp as $select) { ?>
                                                                        <option value="<?php echo $select['value']; ?>" <?php if (isset($value['l2position']) && ($value['l2position'] == $select['value'])) {echo 'selected="true"';}?>> <?php echo $select['label']; ?> </option>
                                                                    <?php }}?>
                                                        ...
                                                        <div class="form-group m-t-3">
                                                                ...
                                                                <select data-parsley-errors-container="#errors-1" class="form-control chosen-select" id="1" name="l2type[]">
                                                                    ...
                                                                    <?php if (!empty($type)) {
                                                                        foreach ($type as $select) {?>
                                                                            <option value="<?php echo $select['value']; ?>" <?php if (isset($value['l2type']) && ($value['l2type'] == $select['value'])) {echo 'selected="true"';}?>> <?php echo $select['label']; ?> </option>
                                                                        <?php }}?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6"><label>Comments</label></div>
                                                                <div class="col-md-6 m-t-3">
                                                                    <textarea id="what_happned" class="form-control timer-sty"  placeholder="Comments" name="l2comments[]"><?=!empty($value['l2comments']) ? $value['l2comments'] : ''?></textarea>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6"><label>Time</label></div>
                                                                <div class="col-md-6 m-t-3"> <div class="input-group input-append bootstrap-timepicker">
                                                                    <input type="text" class="red form-control aaiaddtime addtime_data timer-sty" name="l2time_sequence[]" id="l2time_sequence_data<?php echo $se; ?>" placeholder="" value="<?=!empty($value['l2time_sequence']) ? $value['l2time_sequence'] : ''?>" data-parsley-errors-container="#errors-containertime_event" readonly="">
                                            ...
                                            <div class=" section_seven text-center mb30 col-md-12">
                                                ...
                                                <a id="l2add_new_sequence_of_events_updates" class="btn btn-default" href="javascript:;">
                                        ...
                                        ?>
                                        <div class="col-md-12   " id="div_<?=$row['name']?>">
                                            <div class="form-group">
                                             <h2 class="aai-header-title col-md-12"><?=!empty($row['label']) ? $row['label'] : ''?> <?=!empty($row['required']) ? '<span class="astrick">*</span>' : ''?></h2>
                                             <div class="col-md-12">
