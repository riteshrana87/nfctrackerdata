<div class="panel panel-default incident_process">
    ...
    <div class="panel-body form-horizontal">
        <div class="row aai-module clear-div-flex">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                     ...
                     if(!empty($aai_report_com)){ 
                        ...
                        <?php 
                        $check_user_data = checkUserDetail($incidentData['incident_id'],$l6reference_number,$incidentData['yp_id'],'L6',$loggedInUser['ID']); 
                        if(empty($check_user_data)){
                            $l6_report_compiler = getUserName($loggedInUser['ID']); ?>
                            <input type="text" disabled="true" class="form-control" value="<?= (isset($l6_report_compiler))? $l6_report_compiler:'' ?>">                                
                        <?php } ?>  
            ...
            <div class="col-sm-12 clear-div-flex" id="l6_add_sequence_data">
                <?php if(!empty($l6sequence_data)){ 
                    $ilsx=1;
                    foreach ($l6sequence_data as $value) { ?>
                        <div class="col-md-6 col-sm-12 dynamic-div" id="item_new_sequence_six_<?php echo $ilsx; ?>">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                   ...
                                   <input name="l6sequence_number[]" class="red form-control input-textar-style" value="<?php echo 'S'.$ilsx?>" type="text" />
                               </div> </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select data-parsley-errors-container="#errors-1" class="form-control chosen-select" id="1" name="l6who_raised_complaint[]">

                                       <option value=''> Select user </option>

                                       <?php if(!empty($bambooNfcUsers)) {
                                        foreach ($bambooNfcUsers as $select) {  ?>
                                            <option value="<?php echo $select['user_type'].'_'.$select['user_id'];?>" <?php if(isset($value['who_raised']) && ($value['who_raised'] == $select['user_type'].'_'.$select['user_id'])){echo 'selected="true"';}?>> <?php echo $select['first_name'] . ' ' . $select['last_name'] . ' - ' . $select['email'] ;?> </option>
                                        <?php } } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea id="what_happned" class="form-control input-textar-style" placeholder="Daily action outcome"  name="l6what_happened[]"><?= !empty($value['What_happened']) ? $value['What_happened'] : '' ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                            <input class="form-control aai_adddate input-textar-style" value="<?= !empty($value['date']) ? configDateTime($value['date']) : '' ?>" name="l6sequence_date[]" id="safe_addtime_data" type="text" />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 m-t-3"><div class="input-group input-append bootstrap-timepicker">
                                    <input type="text" class="red form-control aaiaddtime addtime_data timer-sty" name="l6time_sequence[]" id="l6time_safeguard<?php echo $ilsx; ?>" placeholder="" value="<?= !empty($value['time']) ? $value['time'] : '' ?>" data-parsley-errors-container="#errors-containertime_event" readonly="">
                                    <span class="input-group-addon add-on l6time_safeguard<?php echo $ilsx; ?>"><i class="fa fa-clock-o"></i></span>
                                </div>

                            </div> 
                        </div> 
                        <div class="col-md-12 col-sm-2 add_items_field mb44 del-btn-form">
                            <a class="btn btn-default btn_border">
                                <span class="glyphicon glyphicon-trash" onclick="delete_sequence_six_row('item_new_sequence_six_<?php echo $ilsx; ?>');"></span>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-md-12 section_seven text-center mb30">
                <input type="hidden" id="delete_safeguard_review_id" name="delete_safeguard_review_id" value="">
                <a id="l6_add_new_sequence_of" class="btn btn-default updat_bn" href="javascript:;">
        ...
        <?php }?>
          ...
          <?php if($row['className'] == 'bamboo_lookup'){ ?>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <h2 class="aai-header-title col-md-12 aai-form-ttle"><?= !empty($row['label']) ? $row['label'] : '' ?></h1>
                </div>
            </div>
        ...
        <?php } 
                            ...
                            <div class="col-xs-12">
                                <div class="pull-right btn-section">
                                    <div class="btn-group">
                                        <button type="submit" class="btn btn-default" name="draft_wrform" id="draft_wrform" style="default" onclick="$('#saveAsDraftL6').val(1);">Save as Draft</button>
