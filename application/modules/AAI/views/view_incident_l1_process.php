                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                     <?php if (!empty($preveditl1Data)) {
                                        $diff = new HtmlDiff(html_entity_decode($preveditl1Data["$dd"]), html_entity_decode($row['value']));
                                        $diff->build();
                                                ...
                                                <?php if(!empty($bambooNfcUsers)) {
                                                    foreach ($bambooNfcUsers as $select) {  
                                                        if(isset($row['value']) && ($row['value'] == $select['user_type'].'_'.$select['user_id'])){ ?>
                                                            ...
                                                            <?php if (!empty($preveditl1Data) && $preveditl1Data["$dd"] != $row['value']) {
                                                        ...
                                                        <div class="col-md-12">
                                                            <?php if(!empty($bambooNfcUsers)){
                                                                foreach ($bambooNfcUsers as $select){ 
                                                                    ...
                                                                    $staff_present = array_diff($row['value'],$preveditl1Data["$dd"]);
                                                                    ...
                                                                    <?php if(count($row['values']) > 0) {
                                                                        ...
                                                                        foreach ($row['values'] as $select) {  
                                                                            if((in_array($select['value'],$row['value']))){
                                                                                $staff_present_data = array_diff($row['value'],$preveditl1Data["$dd"]);
