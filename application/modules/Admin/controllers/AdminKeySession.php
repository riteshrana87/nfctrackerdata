...
class AdminKeySession extends CI_Controller {
    ...
    public function edit($id) {
        $formInfo = $this->common_model->get_records(KS_FORM, '', '', '', array('ks_form_id' => $id));
        if (!empty($formInfo)) {
            $this->formValidation();
            if ($this->form_validation->run() == FALSE) {
                if (is_numeric($id)) {
    ...
    public function updateModule() {
        ...
        $fields_data = array('ks_id', 'yp_id', 'created_by', 'created_date', 'is_archive', 'modified_date', 'created_by', 'modified_by', 'signoff', 'draft', 'is_delete', 'care_home_id', 'is_concluded');
