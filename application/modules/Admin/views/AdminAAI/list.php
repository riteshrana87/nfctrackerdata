...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">BambooHr Users </li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">BambooHr Users</h3>
                        <?php ?>
                        <a class="btn  pull-right btn-primary howler" title="Add New" href="<?=base_url($this->type.'/'.$this->viewname.'/syncBambooData');?>">Sync </a>
                        <?php  ?> 
