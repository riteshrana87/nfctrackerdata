    ...
    foreach ($information as $row) {
        ...
        ?>
                    ...
                    <tr id="customer_ids">
                        ...
                        <td class="">
         <a class="btn btn-xs btn-primary" href="<?php echo base_url($crnt_view.'/view/'.$row['care_home_id']);?>" title="View Record"><i class="fa fa fa-file-text-o"></i></a>

         <a class="btn btn-xs btn-primary" href="<?= $this->config->item('admin_base_url') . $this->viewname; ?>/edit/<?= $row['care_home_id'] ?>" title="Edit Record"><i class="fa fa-pencil"></i></a>
    <button class="btn btn-xs btn-danger" title="Delete Record"  onclick="delete_request(<?php echo $row['care_home_id'] ?>);"> <i class="fa fa-times"></i> </button>
