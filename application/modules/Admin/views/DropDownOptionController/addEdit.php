        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <?php
                        $attributes = array("name" => "dropdown_option_form", "id" => "dropdown_option_form", "data-parsley-validate" => "" ,"class" => "form-horizontal");
                    ...
                    <div class="col-sm-12 text-center">
                        <div class="bottom-buttons">
                           <?php if(!isset($readonly)){ ?>
                                <input name="option_id" id="option_id" type="hidden" value="<?=!empty($editRecord[0]['option_id'])?$editRecord[0]['option_id']:''?>" />
                                <input type="hidden" id="form_secret" name="form_secret"  value="<?php echo createFormToken();?>">
                                <?php if($formAction == ""){?>
                                    <input type="submit" class="btn btn-primary" name="submit_btn" id="submit_btn" value="Create Option" />
                                <?php }else{?>
                                    <input type="submit" class="btn btn-primary" name="submit_btn" id="submit_btn" value="Update Option" />
                                <?php }?>

                            <a href="<?php echo base_url('Admin/DropDownOptionController/index/'.$dropdownId) ?>" class="btn btn-default">Cancel</a>
                            <?php } ?>
                        </div>
                    </div>
                        </div><!-- /.box-body -->
