            ...
            <div class="col-xs-12">
                ...
                <div class="panel panel-default tile tile-profile m-t-10">
                    <div class="panel-body min-h-310">
                        <h2>Add New Administer Medication</h2>
                        <form action="<?=base_url('Medical/insert_administer_medication')?>" method="post" id="doform" name    ="doform" data-parsley-validate enctype="multipart/form-data">
                        ...
                        if(!empty($form_data))
                        {
                                ...
                                { 
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                        <?php } ?>
                                         <div class="<?=(!empty($row['subtype']) && $row['subtype'] == 'time')?'input-group input-append bootstrap-timepicker':''?><?=(!empty($row['type']) && $row['type'] == 'date')?'input-group input-append bootstrap-datepicker':''?>">
                                               <input type="<?=(!empty($row['type']) && $row['type']=='number')?'number':((!empty($row['subtype']) && $row['subtype'] !='time')?$row['subtype']:'text')?>"
                                                ...
                                                <span class="input-group-addon add-on adddate" ><i class="fa fa-calendar"></i></span>
                                                    <?php } ?>
                                            </div>
                         ...
                         ?>
                             ...
                             <div class="col-sm-12">                                
                                    <button type="submit" class="btn btn-default m-b-xs-15" name="submit_ppform" id="submit_ppform" value="submit" style="default">Add New Administer Medication</button>
