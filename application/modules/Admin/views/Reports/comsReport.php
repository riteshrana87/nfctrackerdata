            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Coms Reports</h3>
                    ...
                    <div class="box-body">
                        <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap">
                            ...
                            <div class="row">                                
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-6 m-b-md-10 text-left">
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-6 m-b-md-10 text-left">
                                                ...
                                                <select class='form-control chosen-select' id='communication_type' name='communication_type'>
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-6 m-b-md-10 text-right">
