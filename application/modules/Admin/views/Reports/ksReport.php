            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">KS Reports</h3>
                    ...
                    <div class="box-body">
                        <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap">
                            ...
                            <div class="row">                                
                                ...
                                <div id="example1_filter" class="dataTables_filter m-b-lg-10 m-b-xs-10 m-b-sm-10">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 m-b-md-10">
                                    ...
                                    <div class="col-lg-2  col-md-8 col-sm-12 text-right m-b-md-10">
