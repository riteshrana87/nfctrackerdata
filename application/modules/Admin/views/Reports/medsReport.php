            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">MEDS Reports</h3>
                    ...
                    <div class="box-body">
                        <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap">
                            ...
                            <div class="row">                                
                                    ...
                                    <div id="example1_filter" class="dataTables_filter m-b-lg-10 m-b-xs-10">
                                    <div class="col-lg-2 col-md-4 col-sm-6 text-left m-b-md-10">
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-6 text-left m-b-md-10">
                                                ...
                                                <select class='form-control chosen-select' id='medical_number' name='medical_number'>
                                                    <option value=''>Select Medical No </option>
                                                    <?php foreach ($medical_number as $loginData) { ?>
                                                        <option value="<?= $loginData['medical_number'] ?>" ><?= $loginData['medical_number']; ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="col-lg-2 col-md-4 col-sm-6 m-b-md-10">
                                                ...
                                                <div class="input-group" id='date_received'>
                                                    <input type="text" class="form-control" placeholder="Date Received" name='date_received' value=''>
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-calendar" aria-hidden="true"></i>
                                                    </div>
                                                </div>
