                                    ...
                                    <div class="col-lg-4 col-md-3 col-sm-6 text-left">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6">
                                          <div class="input-group" id='admin_report_start_date'>
                                                    <input type="text" class="form-control" placeholder="Select Start Date" name='admin_report_start_date' value=''>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6">
                                                ...
                                                <div class="input-group" id='admin_report_end_date'>
                                                    <input type="text" class="form-control" placeholder="Select End Date" name='admin_report_end_date' value=''>
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-calendar" aria-hidden="true"></i>
                                                    </div>
                                                </div>
