<div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingThree">
        <h4 class="panel-title">
            <a id="incident_l1_form_link" class="collapsed accordion-toggle text-uppercase" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                ...
                if (!empty($l1_form_data)) {
                    foreach ($l1_form_data as $row) {
                        ...
                        if ($row['type'] == 'textarea') { ?>
                            ...
                            <div class="col-sm-4" id="div_<?= $row['name'] ?>">
                                    <div class="form-group">
                                        <h2 class="aai-header-title col-md-12"><?=!empty($row['label'])?$row['label']:''?> <?=!empty($row['required'])?'<span class="astrick">*</span>':''?></h2>
                                        <div class="col-md-12">        
                         ...
                         <?php  if($row['name'] == 'l1_staff_member_list' || $row['name'] == 'l1_involved_employee'){
                                    if($is_staff_injured == 1 || $row['name'] == 'l1_involved_employee'){ ?>
                                        <div class="col-md-4" id="div_<?= $row['name'] ?>">
                                                <div class="form-group">
                                                     <h2 class="aai-header-title col-md-12"><?=!empty($row['label'])?$row['label']:''?> <?=!empty($row['required'])?'<span class="astrick">*</span>':''?></h2>
                                                     <div class="col-md-12">
                            ...
                            <?php   } 
                                    ...
                                    <div class="col-sm-4" id="div_<?= $row['name'] ?>">
                                        ...
                                        <h2 class="aai-header-title col-md-12"><?=!empty($row['label'])?$row['label']:''?> <?=!empty($row['required'])?'<span class="astrick">*</span>':''?></h2>
                                        <div class="col-md-12">
                                                <select data-parsley-errors-container="#errors-<?= $row['name'] ?>" <?= (!empty($row['name']) && $row['name'] == 'l1_location_incident')? 'onchange="l1_location_change(this)"':'' ?> class="chosen-select <?=!empty($row['className'])?$row['className']:''?>" name="<?=!empty($row['name'])?$row['name']:''?>" id="<?=!empty($row['name'])?$row['name']:''?>" <?=!empty($row['required'])?'required=true':''?>>
