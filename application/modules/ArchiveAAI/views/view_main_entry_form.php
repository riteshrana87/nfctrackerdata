        ...
        <div class="panel-body form-horizontal">
            <div class="row clear-div-flex">
                <div class="col-md-12 m-b-15">
                            ...
                            <div class="col-md-3 col-sm-12 left_line"> Type of incident </div>
                            <div class="col-md-9 col-sm-12 left_line form-group">
                                <?php 
                                if($isCareIncident == 2){
                                    $checkEdu1 = 'checked';
                                    $checkCare2 = '';
                            ...
                            <?php } ?>
                            <div class="col-md-3 col-sm-12 left_line"> Is the incident related to any other recorded incident? </div>
                            <div class="col-md-9 col-sm-12 left_line form-group">
                                <?php
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <?php if (isset($YPIncidentData) && count($YPIncidentData) > 0) { ?>
                                                <?php foreach ($YPIncidentData as $incidentDetail) { ?>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" disabled="" class="incidentCheckbox" onclick="incident_check_list()" value="<?php echo $incidentDetail['incident_id']; ?>" <?= (in_array($incidentDetail['incident_id'], $relatedIncidentArray))? 'checked':'' ?>>
                                                        </td>
                ...
                if (!empty($entry_form_data)) {
                    foreach ($entry_form_data as $key => $row) {
                        ...
                        <div class="col-md-6 col-sm-12">
                                ...
                                ?>
                                <?php echo $entry_report_compiler; ?>                                
