<!-- main content start-->
                ...
                <h1 class="page-title">
                    ...
                    <div class="pull-right for-tab">
                        <div class="btn-group">
                            ...
                            <a href="<?=base_url('Concerns/index/'.$ypid); ?>" class="btn btn-default btn-xs-100">
                                     <i class="fa fa-mail-reply"></i> Concerns
                                </a>
                                <a href="<?=base_url('ArchiveConcerns/index/'.$ypid); ?>" class="btn btn-default btn-xs-100">
                    ...
                    <a href="<?=base_url('ArchiveCarehome/view/'.$ypid.'/'.$care_home_id.'/'.$isArchiveCareHomePage); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> YP INFO
                              ...
                              <a href="<?=base_url('Concerns/index/'.$ypid.'/'.$care_home_id.'/'.$isArchiveCareHomePage); ?>" class="btn btn-default btn-xs-100">
                                     <i class="fa fa-mail-reply"></i> Concerns
                                </a>
                                <a href="<?=base_url('ArchiveConcerns/index/'.$ypid.'/'.$care_home_id.'/'.$isArchiveCareHomePage); ?>" class="btn btn-default btn-xs-100">
                                     <i class="fa fa-mail-reply"></i> BACK
                                </a>
    ...
    //                                                         echo date('H:i', strtotime($data[$row['name']]));
                ...
                if(!empty($ks_form_data))
                {
                 ...
                 ?>
                 <?php if (checkPermission('ArchiveConcerns', 'signoff')) { 
