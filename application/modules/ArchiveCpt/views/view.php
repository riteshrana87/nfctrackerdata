<!-- main content start-->
                    ...
                    <div class="pull-right for-tab">
                        <div class="btn-group">
                            ...
                            <a href="<?=base_url('CarePlanTarget/index/'.$ypid); ?>" class="btn btn-default">
                             ...
                             <a href="<?=base_url('ArchiveCpt/index/'.$ypid); ?>" class="btn btn-default btn-xs-100">
                    ...
                    <a href="<?=base_url('ArchiveCarehome/view/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> YP INFO
                            ...
                            <a href="<?=base_url('CarePlanTarget/index/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                             ...
                             <a href="<?=base_url('ArchiveCpt/index/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default btn-xs-100">
                                     <i class="fa fa-mail-reply"></i> BACK
                                </a>
    ...
    //                                                         echo date('H:i', strtotime($data[$row['name']]));
                ...
                if(!empty($cpt_form_data))
                {
                 ...
                 ?>
                 <?php if (checkPermission('ArchiveCpt', 'signoff')) { 
