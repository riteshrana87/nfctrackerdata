 ...
 <div id="page-wrapper">
    <div class="main-page">
        ...
        <h1 class="page-title">
            ARCHIVED INDIVIDUAL BEHAVIOUR PLAN <small>New Forest Care</small>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default tile tile-profile">
                    <div class="panel-body">
                        <h2>ARCHIVED INDIVIDUAL BEHAVIOUR PLAN</h2>
                        <div class="refresh-btn">
                                <?php if($past_care_id !== 0){ ?>
                                       <a href="<?php echo base_url() . 'Ibp/external_approval_list/'.$ypid.'/'.$ibp_id.'/'.$care_home_id.'/'.$past_care_id; ?>" > <span class="label label-warning"><?php echo lang('external_approval_list'); ?></span>
                                      </a>
                                <?php } ?>
                              ...
                              <div class="form-group">
                                <div class="input-group search">
                                    <div class="input-group-btn">
                                        ...
                                        <a onclick="data_search_archive_ibp('changesearch')" class="btn btn-primary"  title="<?=$this->lang->line('search')?>"><?=$this->lang->line('common_search_title')?> <i class="fa fa-search fa-x"></i>
                                    </a>
                     ...
                     <div class="clearfix"></div>
                        ...
                        <div class="whitebox ibp_table" id="common_div">
