 ...
 <div id="page-wrapper">
    <div class="main-page">
        ...
        <h1 class="page-title">
            ARCHIVED Individual Strategies <small>New Forest Care</small>
			...
			if($is_archive_page==0){?>
                <div class="btn-group">
                    ...
                    <?php if(checkPermission('IndividualStrategies','view')){ ?>
                            <a href="<?=base_url('IndividualStrategies/index/'.$ypid); ?>" class="btn btn-default width_a">
            ...
            <div class="col-sm-12">
                <div class="panel panel-default tile tile-profile">
                    <div class="panel-body">
                        <h2>Archived Individual Strategies</h2>
                        <div class="refresh-btn">
                                            <button class="btn btn-default btn-sm" onclick="reset_data_archive_is()" title="<?=$this->lang->line('reset')?>"><?=$this->lang->line('common_reset_title')?><i class="fa fa-refresh fa-x"></i>
                                        </button>
                                       </div>
                              ...
                              <div class="form-group">
                                <div class="input-group search">
                                    <div class="input-group-btn">
                                        ...
                                        <a onclick="data_search_archive_is('changesearch')" class="btn btn-primary"  title="<?=$this->lang->line('search')?>"><?=$this->lang->line('common_search_title')?> <i class="fa fa-search fa-x"></i>
                                    </a>
									<button class="btn btn-default" onclick="reset_data_archive_is()" title="<?=$this->lang->line('reset')?>"><?=$this->lang->line('common_reset_title')?><i class="fa fa-refresh fa-x"></i>
                                </button>
                     ...
                     <div class="clearfix"></div>
                        ...
                        <div class="whitebox is_table" id="common_div">
