<!-- main content start-->
        <div id="page-wrapper">
            <div class="main-page">
                ...
                <h1 class="page-title">
                    ARCHIVED Key Sessions <small>New Forest Care</small>
                    <div class="pull-right for-tab">
                        <div class="btn-group">
                            ...
                            <a href="<?=base_url('KeySession/index/'.$ypid); ?>" class="btn btn-default btn-xs-100">
                              <i class="fa fa-mail-reply"></i> Return To Current Key Session
                            </a>
                            <?php } ?>
                            <?php }else{ ?>
                    ...
                    <a href="<?=base_url('ArchiveCarehome/view/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> YP INFO
                            ...
                            <?php if(checkPermission('KeySession','view')){ ?>
                            <a href="<?=base_url('KeySession/index/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default btn-xs-100">
                              <i class="fa fa-mail-reply"></i> Return To Current Key Session
                            </a>
                            <?php } ?>
                            <?php } ?>
