            ...
            <div class="main-page">
                ...
                <h1 class="page-title">
                    ...
                    <div class="pull-right for-tab">
                        <div class="btn-group">
                            ...
                            <a href="<?=base_url('RiskManagementPlan/index/'.$ypid); ?>" class="btn btn-default">
                                     <i class="fa fa-mail-reply"></i> Risk Management Plan
                                </a>
                             <a href="<?=base_url('ArchiveRMP/index/'.$ypid); ?>" class="btn btn-default btn-xs-100">
                     ...
                     <a href="<?= base_url('ArchiveCarehome/view/' . $ypid. '/'. $care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> YP INFO
                            ...
                            <a href="<?=base_url('RiskManagementPlan/index/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                                     <i class="fa fa-mail-reply"></i> Risk Management Plan
                                </a>
                             <a href="<?=base_url('ArchiveRMP/index/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default btn-xs-100">
                                     <i class="fa fa-mail-reply"></i> BACK
                                </a>
               ...
               <h1 class="page-title">
                ...
                if(!empty($ks_form_data))
                {
                 ...
                 ?>
                 <?php if (checkPermission('ArchiveRMP', 'signoff')) { 
                    ...
                    <div class="col-xs-12">
                        <div class="pull-right btn-section">
                            <div class="btn-group capsBtn">
                                <?php 
                            /* condition added by Ritesh Rana on 04/10/2018 to archive functionaity */
                                if($past_care_id == 0){ ?>
                            <a href="<?=base_url('YoungPerson/index/'.$YP_details[0]['care_home'])?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default"><i class="fa fa-mail-reply"></i> CARE HOME YP LIST</a>
                            <a href="<?=base_url('YoungPerson/view/'.$ypid); ?>" class="btn btn-default">
                                    <i class="fa fa-mail-reply"></i> YP INFO
