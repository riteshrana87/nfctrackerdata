<!-- main content start-->
        <div id="page-wrapper">
            <div class="main-page"> <?php // pr($form_data);exit;?>
                <?php
                ...
                <h1 class="page-title">
                    ...
                    <div class="pull-right">
                        <div class="btn-group">
                            ...
                            <?php } ?> 
                            <a href="<?=base_url('ArchiveWr/index/'.$ypid); ?>" class="btn btn-default btn-xs-100">
            ...
            <div class="row">
                ...
                if(!empty($form_data))
                {
                                             ...
                                             if(!empty($appointment_view_comments)){ 
                                                foreach ($appointment_view_comments as $comments_data) {
                                                    if($row['appointment_id'] == $comments_data['md_appoint_id']){ ?>                                                        
                                                                    ...
                                                                    <p class="date"><small><?php echo $comments_data['create_name'] ?>:   <?php echo date("d/m/Y", strtotime($comments_data['created_date'])) ?></small></p>
                                                    <?php } ?>
                                                <?php } } ?>
                                         </div>
                                       </div>
                 ...
                 ?>
                    <?php
                    if (checkPermission('ArchiveWr', 'signoff')) { ?>
            <div class="col-sm-12">
                <div class="panel panel-default tile tile-profile">
