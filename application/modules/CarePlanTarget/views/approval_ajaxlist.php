    ...
    <div class="col-xs-12 m-t-10">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <input class="" type="hidden" name="uri_segment" id="uri_segment" value="<?=!empty($uri_segment)?$ypid.'/'.$cpt_id.'/'.$uri_segment:$ypid.'/'.$cpt_id.'/0'?>">  
                <?php }else{ ?>
                <input class="" type="hidden" name="uri_segment" id="uri_segment" value="<?=!empty($uri_segment)?$ypid.'/'.$cpt_id.'/'.$care_home_id.'/'.$past_care_id.'/'.$uri_segment:$ypid.'/'.$cpt_id.'/'.$care_home_id.'/'.$past_care_id.'/0'?>">  
                <?php }?>
                    ...
                    <?php foreach ($information as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    if($past_care_id == 0){ ?>
                                    <a href="<?php echo base_url($crnt_view.'/viewApprovalCpt/'.$data['cpt_signoff_details_id'].'/'.$ypid);?>" class="btn btn-link btn-blue"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                    <?php 
                                    ...
                                    <a href="javascript:;" onclick="resendMail(<?php echo $data['cpt_signoff_details_id'] ; ?>,<?php echo $data['yp_id'] ; ?>,<?php echo $cpt_id; ?>);" class="btn btn-default width_a" title="Resend">Resend</a>
                                    <?php } } ?>
                                    <?php }else{ ?>
                                    <a href="<?php echo base_url($crnt_view.'/viewApprovalCpt/'.$data['ks_signoff_details_id'].'/'.$ypid.'/'.$care_home_id.'/'.$past_care_id);?>" class="btn btn-link btn-blue"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                    <?php } ?>
