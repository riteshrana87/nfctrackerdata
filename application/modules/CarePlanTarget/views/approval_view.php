        ...
        <h1 class="page-title">
            ...
            <div class="pull-right">
                <div class="btn-group">
                    <?php 
                if($past_care_id == 0){ ?>
                   <a href="<?=base_url('CarePlanTarget/external_approval_list/'.$ypid.'/'.$cpt_id); ?>" class="btn btn-default width_a">
                        <i class="fa fa-mail-reply"></i> BACK TO PAGE
                    </a>
                    <?php }else{ ?>
<a href="<?=base_url('CarePlanTarget/external_approval_list/'.$ypid.'/'.$cpt_id.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default width_a">
                        <i class="fa fa-mail-reply"></i> BACK TO PAGE
                    </a>                        
                    <?php } ?>
                </div>
        ...
        <div class="row">
            ...
            <?php if (checkPermission('CarePlanTarget', 'signoff')) { 
