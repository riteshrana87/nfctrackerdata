                ...
                <h1 class="page-title">
                    ...
                    <div class="pull-right for-tab">
                        ...
                        if($past_care_id == 0){ ?>
                            ...
                            <?php if(checkPermission('CarePlanTarget','add')){ ?>
                            <a href="<?=base_url('CarePlanTarget/create/'.$ypid); ?>" class="btn btn-default">
                                    <i class="fa fa-edit"></i> CREATE CPT
                                </a>
                            <?php } ?>
                            <?php if(checkPermission('ArchiveCpt','view')){ ?>
                            <a href="<?=base_url('ArchiveCpt/index/'.$ypid); ?>" class="btn btn-default">
                            ...
                            <?php if(checkPermission('ArchiveCpt','view')){ ?>
                            <a href="<?=base_url('ArchiveCpt/index/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                                <i class="fa fa-search"></i> VIEW ARCHIVE
                            </a>
                            <?php } ?>    
                            <?php } ?>
