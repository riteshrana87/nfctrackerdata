        ...
        <h1 class="page-title">
            ...
            <div class="pull-right for-tab">
                <div class="btn-group">
                    ...
                    if($past_care_id == 0){ ?>
                    <a href="<?=base_url('CarePlanTarget/view/'.$cpt_id.'/'.$ypid); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Return To Current CPT
                    </a>
                    ...
                    <?php }else{ ?>
                    <a href="<?=base_url('CarePlanTarget/view/'.$cpt_id.'/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Return To Current CPT
                    </a>
