<section class="invoice">
    ...
    <div class="row invoice-info">
        <div class="col-xs-12">
            <p class="lead" style="margin-bottom: 15px; font-size: 18px; text-transform: uppercase; font-weight: 900;">Clothing Money</p>
        </div>
    ...
    <div class="clearfix"></div>
            ...
            <table class="table table-bordered table-striped">
                    <thead>
                                            ...
                                            foreach ($form_data as $row) {
                                                ...
                                                <td> 
                                                    ...
                                                    if((!empty($data[$row['name']]) && $data[$row['name']] !='0000-00-00')){
                                                            echo configDateTimeFormat($data[$row['name']]);
                                                    }
                                                    ?>
                                                </td>
                                                <?php }else if ($row['subtype'] == 'time') { ?>
                        ...
                        <?php } ?>
                        <tr><td colspan="10"  style="margin-bottom: 15px; font-size: 18px; text-transform: uppercase; font-weight: 900;">Clothing Money balance : <?=!empty($yp_clothing_money[0]['total_balance'])?$yp_clothing_money[0]['total_balance']:0?></td></tr>
                    <?php } else { ?>
                        <tr>
