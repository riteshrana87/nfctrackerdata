            ...
            <div class="pull-right for-tab">
                <div class="btn-group">
                    <?php if($past_care_id == 0){?>
                     <a href="<?= base_url('Communication/external_approval_list/'. $ypid .'/'. $coms_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> BACK TO PAGE
                    </a>
                    <?php }else{ ?>
                     <a href="<?= base_url('Communication/external_approval_list/'. $ypid .'/'. $coms_id.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> BACK TO PAGE
                    </a>
                    <?php } ?>
