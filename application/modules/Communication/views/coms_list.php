            ...
            <div class="pull-right for-tab">
                <div class="btn-group">
                    ...
                    /* condition added by Ritesh Ranan on 28/09/2018 to archive functionality */
                     if($past_care_id == 0){?>
                    <a href="<?=base_url('Communication/view/'.$coms_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Return To Current Com
                    </a>
                    ...
                    <?php }else{ ?>
                    <a href="<?=base_url('Communication/view/'.$coms_id.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Return To Current Com
                    </a>
