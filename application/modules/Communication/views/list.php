<div id="page-wrapper">
    <div class="main-page">
     <div class="sticky-heading" id="sticky-heading">
        <h1 class="page-title">
            Communication Log <small>New Forest Care</small>
            <div class="pull-right for-tab">
                ...
                <?php if(checkPermission('Communication','add')){ ?>
                <a href="<?=base_url('Communication/add_communication/'.$ypid); ?>" class="btn btn-default">
                    <i class="fa fa-edit"></i> ADD COMMUNICATION
                </a>
                <?php } ?>
                <?php }else{ ?>
