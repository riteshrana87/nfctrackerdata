<script>
    ...
    var ypc_id = '<?=!empty($edit_data[0]['ypc_id'])?$edit_data[0]['ypc_id']:''?>';
</script>
<!-- main content start-->
<div id="page-wrapper">
 <form action="<?= base_url('Concerns/insert') ?>" method="post" id="ksform" name="ksform" data-parsley-validate enctype="multipart/form-data">
          ...
          <h1 class="page-title">
            ...
            <div class="pull-right for-tab">
                <div class="btn-group capsBtn">
                    <button type="submit" onclick="needToConfirm = false;"  class="btn btn-default" name="submit_ypcform" id="submit_ypcform" value="submit" style="default"><?php if(!empty($edit_data)){
                        echo "Update";
                    }else{
                        echo "Create";
                    } ?></button>
                    ...
                    <a href="<?=base_url($this->viewname .'/index/'.$ypid)?>" class="capsBtn btn btn-default" style="default">Back To Concerns</a>
                ...
                if (!empty($ks_form_data)) {
                    ...
                    <div class="col-sm-12 capsBtn">
                        <div class="">
                                ...
                                <?php /* care home id added by Dhara Bhalala for carehome YP archive */ ?>
                                ...
                                <input type="hidden" name="ypc_id" id="ypc_id" value="<?=!empty($edit_data[0]['ypc_id'])?$edit_data[0]['ypc_id']:''?>">
                                <input type="hidden" id="form_secret" name="form_secret"  value="<?php echo createFormToken();?>">
                    <button type="submit" onclick="needToConfirm = false;"  class="btn btn-default updat_bn" name="submit_ypcform" id="submit_ypcform" value="submit" onclick="$('#saveAsDraft').val(0);" style="default"><?php if(!empty($edit_data)){
                        echo "Update";
                    }else{
                        echo "Create";
                    } ?></button>
                          ...
                          <div class="pull-right btn-section">
                            <div class="btn-group">
                             ...
                             <a href="<?= base_url('YoungPerson/view/' . $ypid) ?>" class=" btn btn-default" style="default">Back To YP Info</a>
                                <a href="<?=base_url('YoungPerson/index/'.$YP_details[0]['care_home'])?>" class=" btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default">CARE HOME YP LIST</a>
                                <input type="hidden" id="form_secret" name="form_secret"  value="<?php echo createFormToken();?>">
                                <a href="<?=base_url($this->viewname .'/index/'.$ypid)?>" class="btn btn-default" style="default">Back To Concerns</a>
                            </div>
                            </div>
