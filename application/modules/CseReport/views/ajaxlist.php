            ...
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        ?> onclick="apply_sortingsdq('user_type', '<?php echo $sorttypepass; ?>')">CSE Completed by</th>
                        ...
                        ?> onclick="apply_sortingsdq('created_date', '<?php echo $sorttypepass; ?>')"> Date Completed</th>
                        ...
                        ?> tabindex="0" aria-controls="example1" rowspan="1" colspan="1" onclick="apply_sortingsdq('care_home_name', '<?php echo $sorttypepass; ?>')"> Care Home Name</th>
                ...
                <tbody>
                    <?php if (isset($cse_record_list) && count($cse_record_list) > 0) { ?>
                        <?php foreach ($cse_record_list as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <?php
                                    if($past_care_id == 0){
                                     if(checkPermission('CseReport','edit')){ ?>
                                    ...
                                    <?php if(checkPermission('CseReport','view')){ ?>
                                        <a href="<?php echo base_url($crnt_view . '/view/' . $data['yp_id'] . '/' . $data['id'].'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-link btn-blue"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                    <?php } } ?>
                                </td>
                            </tr>
                        <?php } ?>
...
<div class="row">
    <div class="col-md-12 m-t-10">
        <?php 
        if($past_care_id == 0){
        if(checkPermission('CseReport','add')){
            ?>
        <a href="<?php echo base_url() . 'CseReport/cseQuestion/' . $ypid; ?>" title="" class="btn btn-default" >Complete an CSE Assessment</a>
        <?php } } ?> 
    </div>
</div>
<?php
