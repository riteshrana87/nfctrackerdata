...
<div id="page-wrapper">
    <div class="main-page">
        ...
        <div class="row">
            <form action="<?=base_url('DailyObservation/insert_summary')?>" method="post" id="doform" name="doform" data-parsley-validate enctype="multipart/form-data">
                    <div class="col-sm-12">
                        <div class="">
                            <h1 class="page-title">ADD <?=!empty($form_data[0]['label'])?$form_data[0]['label']:'';?></h1>
                        </div>
                    </div>
                     ...
                     <div class="col-sm-12">
                        ...
                        */
                        ...
                        <input type="hidden" name="do_id" id="do_id" value="<?=!empty($do_id)?$do_id:''?>">
                            ...
                            <button type="submit" class="btn btn-default" name="submit_doform" id="submit_doform" value="submit" style="default">Add Note</button>
