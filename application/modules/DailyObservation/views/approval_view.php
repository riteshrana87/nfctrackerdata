            ...
            Daily Observations <small>New Forest Care</small>
             <div class="pull-right">
                <div class="btn-group">
                    ...
                    <a href="<?=base_url('DailyObservation/external_approval_list/'.$ypid.'/'.$do_id); ?>" class="btn btn-default">
                                        ...
                                        <li class="media">
                                            <div class="media-body">
                                                ...
                                                <?php if ($row['type'] == 'textarea' || $row['type'] == 'date' || $row['type'] == 'number' || $row['type'] == 'text') { ?>
                                                    ...
                                                    <?php
                                                    if (!empty($row['value']) && is_json(stripcslashes($row['value']))) {
                                                        if (!empty($summary_form_old_data[$n]['name']) && ($row['name'] == $summary_form_old_data[$n]['name'])) {
                                                            $jolddata = json_decode(stripcslashes($summary_form_old_data[$n]['value']));
                                                        }
                                                        $jdata = json_decode(stripcslashes($row['value']));
