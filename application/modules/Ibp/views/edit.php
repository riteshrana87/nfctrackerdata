...
<div id="page-wrapper">
<form action="<?=base_url('Ibp/insert')?>" method="post" id="ppform" name="ppform" data-parsley-validate enctype="multipart/form-data">
    <div class="main-page">
        ...
        <h1 class="page-title">
            INDIVIDUAL BEHAVIOUR PLAN  <small>New Forest Care</small>
                <div class="pull-right for-tab">
                  <div class="btn-group">
                    <button type="submit" class="btn btn-default" name="submit_ibpform" id="submit_ibpform" value="submit" style="default">UPDATE</button>
                    ...
                    <a href="<?=base_url('Ibp/index/'.$ypid)?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default">Back to Current IBP</a>
                  </div>
            </div>
        </h1>
        <h1 class="page-title">
                ...
                <?php if(!empty($form_data)) {
                    ...
                    ?>
                     <div class="col-sm-12 capsBtn">
                        <div class="">
                        <input type="hidden" name="ibp_id" id="ibp_id" value="<?=!empty($edit_data[0]['ibp_id'])?$edit_data[0]['ibp_id']:''?>">
                        ...
                        <input type="hidden" id="form_secret" name="form_secret"  value="<?php echo createFormToken();?>">
                            <button type="submit" class="btn btn-default updat_bn" name="submit_ibpform" id="submit_ibpform" value="submit" style="default">UPDATE</button>
                          <div class="pull-right btn-section">
                            ...
                            <a href="<?=base_url('Ibp/index/'.$ypid)?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" style="default">BACK TO CURRENT IBP</a>
                            </div>
                            </div>
                        </div>
                    </div>
