    ...
    <div class="col-xs-12 m-t-10">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <input class="" type="hidden" name="uri_segment" id="uri_segment" value="<?=!empty($uri_segment)?$ypid.'/'.$is_id.'/'.$uri_segment:$ypid.'/'.$is_id.'/0'?>">  
                </tr>
                </thead>
                <tbody>
                    ...
                    <?php foreach ($information as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                   <a href="<?php echo base_url($crnt_view.'/viewApprovalIs/'.$data['is_signoff_details_id'].'/'.$ypid);?>" class="btn btn-link btn-blue"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                    <?php 
                                    ...
                                    <a href="javascript:;" onclick="resendMail(<?php echo $data['is_signoff_details_id'] ; ?>,<?php echo $data['yp_id'] ; ?>,<?php echo $is_id; ?>);" class="btn btn-default width_a" title="Resend">Resend</a>
                                    <?php } } ?>
