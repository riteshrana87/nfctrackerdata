...
<div id="page-wrapper">
<form action="<?=base_url($this->viewname.'/insert')?>" method="post" id="ppform" name="ppform" data-parsley-validate enctype="multipart/form-data">
    <div class="main-page">
        ...
        <h1 class="page-title">
            INDIVIDUAL STRATEGIES <small> New Forest Care</small>
                <div class="pull-right for-tab">
                  <div class="btn-group">
                    <button type="submit" class="btn btn-default" name="submit_isform" id="submit_isform" value="submit" style="default">UPDATE</button>
                    <a href="<?=base_url('YoungPerson/index/'.$YP_details[0]['care_home'])?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default"><i class="fa fa-mail-reply"></i> CARE HOME YP LIST</a>
                    <a href="<?=base_url('YoungPerson/view/'.$ypid)?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default">Back To YP Info</a>
                    <a href="<?=base_url('IndividualStrategies/index/'.$ypid)?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" style="default">Back to Current IS</a>
                  </div>
                </div>
        </h1>
        <h1 class="page-title">
                ...
                if(!empty($form_data))
                {
                    ...
                    ?>
                                ...
                                <div class="col-sm-12">
                                        <div class="panel panel-default tile tile-profile">
                                                   ...
                                                   <div class="section_three">
                                                    <div class="form-group row" id="add_items">
                                                            <?php if (!empty($item_details)) {
                                                                        ...
                                                                        ?> 
                                                                <div class="delet_bottom form-group newrow" id="item_edit_<?= $row['amendments_id'] ?>">
                                                                    <div class="">
                                                                        <div class="col-sm-10 form-group add_items_field mb44">
                                                                            <textarea class="tinyeditor" name="amendments_<?= $row['amendments_id'] ?>" placeholder="" >
                                                                                <?= !empty($row['amendments']) ? $row['amendments'] : '' ?>
                                                                            </textarea>
                                                                        </div>
                                                                          
                                                                        <div class="col-sm-2 form-group add_items_field">
                                                                            <a class="pull-right btn btn-default">
                                                                                <span class="glyphicon glyphicon-trash" onclick="delete_item_row('item_edit_<?= $row['amendments_id'] ?>');"></span>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class=" section_four text-center mb30">
                                                ...
                                                <a id="add_new_item" class="btn btn-default">
                                                    <span class="glyphicon glyphicon-plus"></span>&nbsp;Add More Amendments
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="panel panel-default tile tile-profile">
                                            ...
                                            <div class="section_three">
                                                <div class="form-group row" id="add_protocols">
                                                        <?php if (!empty($protocols_details)) {
                                                                        foreach ($protocols_details as $row) {
                                                                    ?> 
                                                            <div class="delet_bottom form-group newrow" id="protocols_edit_<?= $row['protocols_in_place_id'] ?>">
                                                                <div class="">

                                                                <div class="col-sm-10 form-group add_items_field mb44">
                                                                    <textarea class="tinyeditor" name="current_protocols_in_place_<?= $row['protocols_in_place_id'] ?>" placeholder="">
                                                                ...
                                                                <div class="col-sm-2 form-group add_items_field ">
                                                                    <a class="pull-right btn btn-default ">
                                                                        <span class="glyphicon glyphicon-trash" onclick="delete_protocols_item_row('protocols_edit_<?= $row['protocols_in_place_id'] ?>');"></span>
                                                                    </a>
                                          ...
                                          <div class=" section_four text-center ">
                                                    <input type="hidden" id="delete_protocols_id" name="delete_protocols_id" value="">
                                                    <a id="add_new_protocols" class="btn btn-default">
                                                        <span class="glyphicon glyphicon-plus"></span>&nbsp;Add More Current Protocols in place
                                                    </a>
                                            </div>
                                            </div>
                                        </div>
                     ...
                     <div class="col-sm-12 capsBtn">
                                <div class="">
                               <input type="hidden" name="individual_strategies_id" id="individual_strategies_id" value="<?=!empty($edit_data[0]['individual_strategies_id'])?$edit_data[0]['individual_strategies_id']:''?>">
                        <input type="hidden" name="yp_id" id="yp_id" value="<?=!empty($edit_data[0]['yp_id'])?$edit_data[0]['yp_id']:$ypid?>">
                        <input type="hidden" id="form_secret" name="form_secret"  value="<?php echo createFormToken();?>">
                                     <button type="submit" class="btn btn-default updat_bn" name="submit_isform" id="submit_isform" value="submit" style="default">UPDATE</button>
                                    ...
                                    <a href="<?=base_url('IndividualStrategies/index/'.$ypid)?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" style="default">BACK TO CURRENT IS</a>
                            <a href="<?=base_url('YoungPerson/index/'.$YP_details[0]['care_home'])?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default"><i class="fa fa-mail-reply"></i> CARE HOME YP LIST</a>
                            <a href="<?=base_url('YoungPerson/view/'.$ypid)?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" style="default">BACK TO YP INFO</a>
                                   </div>
                               </div>
