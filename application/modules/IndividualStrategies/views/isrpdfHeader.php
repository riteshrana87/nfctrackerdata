                                ...
                                <tr>
                                    <td style="">
                                        <table width="100%" cellpadding="20" border="0">
                                            <tbody >
                                                <tr>
                                                    <td align="center" >INDIVIDUAL STRATEGIES RECORD</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="">
                                        <table width="100%" cellpadding="0" border="0">
                                            <tbody>
                                                <tr>
                                                    <!-- <td align="left" style="text-transform: uppercase; font-size: 16px; color: #1766a6;">INDIVIDUAL STRATEGIES RECORD</td>
                                                    <td align="right" style="font-size: 16px; color: #1766a6;">Form No.nfc_f1_s1_isr02</td> -->
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
