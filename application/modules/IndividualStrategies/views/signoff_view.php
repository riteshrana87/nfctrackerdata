...
<div id="page-wrapper">
    <div class="main-page">
        ...
        <h1 class="page-title">
			...
			<div class="pull-right 0000-00-00 00:00:00">
                <div class="btn-group">
                   <a href="<?= base_url('IndividualStrategies/DownloadPDF_after_mail/' . $ypid . '/' . $signoff_id); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Generate PDF </a>
                </div>
            </div>
        </h1>
        <h1 class="page-title">
            ...
            <div class="col-sm-12">
                <div class="panel panel-default tile tile-profile">
                    <div class="panel-body">
                        ...
                        <?php foreach ($ra_signoff_data as $sign_name) { ?>
                                <ul class="media-list media-xs">
                                    <li class="media">
                                        <div class="media-body">
