                ...
                <h1 class="page-title">
                    ...
                    <div class="pull-right for-tab">
                        <div class="btn-group">
                            ...
                            <?php if(checkPermission('KeySession','add')){ ?>
                            <a href="<?=base_url('KeySession/create/'.$ypid); ?>" class="btn btn-default">
                                    <i class="fa fa-edit"></i> CREATE KS
                                </a>
                            <?php } ?>
                            <?php if(checkPermission('ArchiveKs','view')){ ?>
                            <a href="<?=base_url('ArchiveKs/index/'.$ypid); ?>" class="btn btn-default">
                            ...
                            <?php if(checkPermission('ArchiveKs','view')){ ?>
                            <a href="<?=base_url('ArchiveKs/index/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                                <i class="fa fa-search"></i> VIEW ARCHIVE
                            </a>
                            <?php } ?>    
                            <?php } ?>
