...
<section class="invoice">
    ...
    <div class="row invoice-info">
        <div class="col-xs-12">
            <p class="lead" style="margin-bottom: 15px; font-size: 18px; text-transform: uppercase; font-weight: 900;">Keysession</p>
        </div>
            ...
            ?>
                        ...
                        <tbody>
                            <?php if (!empty($comments)) {
                                ...
                                <tr>
                            <td>
                                    <?= !empty($comment['ks_comments']) ? $comment['ks_comments'] : '' ?>
