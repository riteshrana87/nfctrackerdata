        ...
        <h1 class="page-title">
            ...
            <div class="pull-right for-tab">
                <div class="btn-group">
                   ...
                   <a href="<?=base_url('LocationRegister/external_approval_list/'.$ypid.'/'.$lr_id); ?>" class="btn btn-default width_a">
                        <i class="fa fa-mail-reply"></i> BACK TO PAGE
                    </a>
                    <?php }else{ ?>
                     <a href="<?=base_url('LocationRegister/external_approval_list/'.$ypid.'/'.$lr_id.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default width_a">
                        <i class="fa fa-mail-reply"></i> BACK TO PAGE
                    </a>   
                    <?php } ?>
                </div>
