        ...
        <h1 class="page-title">
            ...
            <div class="pull-right for-tab">
                <div class="btn-group">
                    ...
                    if($past_care_id == 0){ 
                    ?>
                    <a href="<?=base_url('LocationRegister/view/'.$lr_id.'/'.$ypid); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Return To Current LR
                    </a>
                    ...
                    <?php }else{ ?>
                    <a href="<?=base_url('LocationRegister/view/'.$lr_id.'/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Return To Current LR
                    </a>
