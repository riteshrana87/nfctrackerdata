            ...
            <table class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        ?> onclick="apply_sorting('care_home_id', '<?php echo $sorttypepass; ?>')">Created By</th>
						<th <?php
                ...
                <input class="" type="hidden" name="uri_segment" id="uri_segment" value="<?=!empty($uri_segment)?$mdt_report_id.'/'.$uri_segment:$mdt_report_id.'/0'?>">  
                </tr>
                </thead>
                <tbody>
                    ...
                    <?php foreach ($information as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo base_url($crnt_view.'/external_view/'.$data['mdt_archive_id'].'/'.$data['mdt_signoff_details_id']);?>" class="btn btn-link btn-blue"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                    <?php 
                                    ...
                                    <a href="javascript:;" onclick="resendMail(<?php echo $data['mdt_signoff_details_id'] ; ?>,<?php echo $data['mdt_report_id'] ; ?>);" class="btn btn-default width_a" title="Resend">Resend</a>
                                    <?php } } ?>
