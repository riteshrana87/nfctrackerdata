                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="hidden" name="mdt_report_id" value='<?=!empty($mdt_report_id)?$mdt_report_id:''?>'>
                            <input type="hidden" name="mdt_archive_id" value='<?=!empty($mdt_archive_id)?$mdt_archive_id:''?>'>
