...
<div id="page-wrapper">
    <div class="main-page">
        ...
        <h1 class="page-title">
			...
			<?php 
                ...
                <div class="btn-group">
                    ...
                    <a href="<?= base_url('MDTReviewReport/index/'.$ypid); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> MDT REPORT
                    </a>
                    <?php if (checkPermission('MDTReviewReport', 'edit')) { ?>
                        <a href="<?= base_url('MDTReviewReport/edit/'.$mdt_report_id.'/'.$ypid); ?>" class="btn btn-default">
                            <i class="fa fa-edit"></i> EDIT MDT
                        </a>
                    <?php } ?>
                    <?php if (checkPermission('ArchiveMDTReport', 'view')) { ?>
                        <a href="<?= base_url('ArchiveMDTReport/index/' . $mdt_report_id); ?>" class="btn btn-default">
                            <i class="fa fa-search"></i> VIEW ARCHIVE
                        </a>
                    <?php } ?>
                   
                    <?php if (!empty($edit_data[0]['mdt_report_id'])) { ?>
                        <a href="<?= base_url('MDTReviewReport/DownloadPdf/' . $edit_data[0]['mdt_report_id'] . '/' . $ypid); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> PDF </a>
                    <?php } ?>
				  ...
				  <?php } else{?>
				   ...
				   <?php if (checkPermission('ArchiveMDTReport', 'view')) { ?>
                        <a href="<?= base_url('ArchiveMDTReport/index/' . $mdt_report_id.'/'.$careHomeId.'/'.$is_archive_page); ?>" class="btn btn-default">
                            <i class="fa fa-search"></i> VIEW ARCHIVE
                        </a>
                    <?php } ?>
				  
				  <a href="<?= base_url('MDTReviewReport/index/'.$ypid.'/'.$careHomeId.'/'.$is_archive_page); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> MDT REPORT
                    </a>
        ...
        <div class="row">
                                ...
                                <div class="panel-body1">
                                    ...
                                    if (!empty($prev_edit_data[0][$row['name']]) && !empty($edit_data[0][$row['name']])) {
                                        if ($prev_edit_data[0][$row['name']] != $edit_data[0][$row['name']]) {
                                            ...
                                            <!--<span class="text-success">&nbsp;<img src="<?php //echo base_url('uploads/custom/img/edit-validated-icon-1.png')  ?>"></span>-->
                                            <?php
                                        }
                                    }
                                    ?>
            ...
            <div class="row">
            <?php  if (checkPermission('MDTReviewReport', 'signoff')) { ?>
                        ...
                        <div class="panel-body1">
                            ...
                            <?php
                                if(empty($check_signoff_data)){
                                    ...
                                    <input type="checkbox" name="is_signoff" onclick="manager_request(<?php echo $ypid.','.$edit_data[0]['mdt_report_id']; ?>);" class="ra_signoff" value="1">
                ...
                <?php } } }?>
                <?php  if (checkPermission('MDTReviewReport', 'document_signoff')) { ?>
                <?php if (!empty($edit_data[0]['mdt_report_id'])) { ?>
				<?php 
				/*ghelani nikunj
					19/8/2018
                ...
                <div class="col-sm-12">
                                <div class="panel panel-default tile tile-profile">
                                    <div class="panel-body1">
                                         <a data-href="<?php echo base_url() . 'MDTReviewReport/signoff/'.$ypid.'/'.$edit_data[0]['mdt_report_id']; ?>"  aria-hidden="true" data-refresh="true" data-toggle="ajaxModal" href="javascript:;" title="" ><span class="label label-warning"><?php echo lang('external_approval'); ?></span></a>
                                         <?php if(!empty($check_external_signoff_data)){ ?>
                                          <a href="<?php echo base_url() . 'MDTReviewReport/external_approve/'.$edit_data[0]['mdt_report_id']; ?>"><span class="label label-warning"><?php echo lang('external_approval_list'); ?></span></a>
                                          <?php } ?>
                                    </div>
                                </div>
                            </div> 
