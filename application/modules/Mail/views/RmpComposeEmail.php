            ...
            <div class="pull-right for-tab">
                <div class="btn-group">
                    ...
                    <a href="<?= base_url('YoungPerson/view/' . $ypid); ?>" class="btn btn-default">
                     ...
                     <a href="<?=base_url('RiskManagementPlan/view/'.$rmp_id.'/'.$ypid); ?>" class="btn btn-default">
...
<div class="row">
    ...
    <!--                                    <select class="form-control">
                                         ...
                                         <input type="hidden" name="ks_file_path" value="<?php echo isset($rmp_file_path) ? $rmp_file_path : ''; ?>">
