            ...
            <div class="pull-right for-tab">
                <div class="btn-group">
                    ...
                    <a href="<?= base_url('YoungPerson/view/' . $ypid); ?>" class="btn btn-default">
                     ...
                     <a href="<?=base_url('CarePlanTarget/view/'.$pp_id.'/'.$ypid); ?>" class="btn btn-default">
...
<div class="row">
    ...
    <!--                                    <select class="form-control">
                                         ...
                                         <input type="hidden" name="ks_file_path" value="<?php echo isset($pp_file_path) ? $pp_file_path : ''; ?>">
