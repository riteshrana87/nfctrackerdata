    ...
    <div class="main-page">
        ...
        <div class="panel panel-default tile tile-profile m-t-10">
            <div class="panel-body min-h-310">
                <h2>EDIT MEDICAL AUTHORISATIONS & CONSENTS</h2>
                <form action="<?=base_url('Medical/insert_mac')?>" method="post" id="docsform" name="docsform" data-parsley-validate enctype="multipart/form-data">
                    <?php
                    if(!empty($form_data))
                    {
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <?php if((!empty($row['subtype']) && $row['subtype'] == 'time') || $row['type'] == 'date'){
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                <?php } ?>
                                                <div class="<?=(!empty($row['subtype']) && $row['subtype'] == 'time')?'input-group input-append bootstrap-timepicker':''?><?=(!empty($row['type']) && $row['type'] == 'date')?(!empty($row['description']) && $row['description'] == 'dob')?'input-group input-append date dob':'input-group input-append date medi_adddate':''?>">
                ...
                {?>
                    ...
                    <?php } ?>
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn-default updat_bn" name="submit_medform" id="submit_medform" value="submit" style="default">Submit</button>
                        <div class="pull-right btn-section">
                            <div class="btn-group">
                            <a href="<?=base_url('Medical/index/'.$ypid)?>" class=" btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default"><i class="fa fa-mail-reply"></i> MEDS</a>
                        </div>
                    </div>
                </div> 
            </form>   
