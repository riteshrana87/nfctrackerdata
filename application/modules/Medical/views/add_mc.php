  ...
  <div class="main-page">
    ...
    <div class="panel panel-default tile tile-profile m-t-10">
      <div class="panel-body min-h-310">
        <h2>Add New Medical Communication and Summary</h2>
        <form action="<?=base_url('Medical/insert_mc')?>" method="post" id="docsform" name="docsform" data-parsley-validate enctype="multipart/form-data">
                      ...
                      <?php
                                  ...
                                  <div class="col-sm-12">
                                    <div class="pull-right btn-section">
                                      <div class="btn-group">
                                         <input type="submit" class="btn btn-default" name="submit_medform" id="submit_medform" value="Add Medical Communication And Summary" />
