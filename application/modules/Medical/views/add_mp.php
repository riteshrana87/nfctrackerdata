    ...
    <div class="main-page">
        ...
        <div class="panel panel-default tile tile-profile m-t-10">
            <div class="panel-body min-h-310">
                <h2>ADD MEDICAL PROFESSIONAL</h2>
                <form action="<?=base_url('Medical/insert_mp')?>" method="post" id="docsform" name="docsform" data-parsley-validate enctype="multipart/form-data">
            ...
            {?>
                ...
                <?php
                            ...
                            ?> <input type="submit" class="btn btn-default updat_bn" name="submit_medform" id="submit_medform" value="Submit" />
                            <div class="col-sm-12">
