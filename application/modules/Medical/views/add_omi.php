    ...
    <div class="main-page">
        ...
        <h1 class="page-title">
         ...
         <div class="panel panel-default tile tile-profile m-t-10">
            ...
            <h2>EDIT OTHER MEDICAL INFORMATION</h2>
                <form action="<?=base_url('Medical/insert_omi')?>" method="post" id="docsform" name="docsform" data-parsley-validate enctype="multipart/form-data">
