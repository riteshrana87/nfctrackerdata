            ...
            <div class="col-xs-12">
                ...
                <div class="panel panel-default tile tile-profile m-t-10">
                    <div class="panel-body min-h-310">
                        ...
                        <form action="<?=base_url('Medical/insert_health_assessment')?>" method="post" id="docsform" name="docsform" data-parsley-validate enctype="multipart/form-data">
                        ...
                        <div class="pull-right btn-section">
                                    <div class="btn-group">                          
                            <input type="submit" class="btn btn-default" name="submit_medform" id="submit_medform" value="Add New Health Assessment" />
                            <a href="<?=base_url('Medical/index/'.$ypid)?>" class=" btn btn-default pull-none-xs" name="submit_ppform" id="submit_ppform" value="submit" style="default">Back To Meds</a>
                        </div>
                    </div>
                </div>
                    </form>      
