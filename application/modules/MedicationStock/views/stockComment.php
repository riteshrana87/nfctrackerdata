...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="exampleModalLabel">Stock Check</h4>
        ...
        <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="form_secret" name="administer_medication_id"  value="<?= !empty($medication_data[0]['administer_medication_id']) ? $medication_data[0]['administer_medication_id'] : '' ?>">
                <input type="hidden" id="form_secret" name="select_medication"  value="<?= !empty($medication_data[0]['select_medication']) ? $medication_data[0]['select_medication'] : '' ?>">
