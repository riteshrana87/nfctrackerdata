    ...
    <div class="col-xs-12 m-t-10">
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <input class="" type="hidden" name="uri_segment" id="uri_segment" value="<?=!empty($uri_segment)?$ypid.'/'.$pp_id.'/'.$uri_segment:$ypid.'/'.$pp_id.'/0'?>">  
                <?php }else{ ?>
                <input class="" type="hidden" name="uri_segment" id="uri_segment" value="<?=!empty($uri_segment)?$ypid.'/'.$pp_id.'/'.$care_home_id.'/'.$past_care_id.'/'.$uri_segment:$ypid.'/'.$pp_id.'/'.$care_home_id.'/'.$past_care_id.'/0'?>">  
                <?php } ?>
                                ...
                                <td class="text-center">
                                  ...
                                  if($past_care_id == 0){ ?>
                                   <?php if (checkPermission('PlacementPlan', 'view')) { ?>
                                    <a href="<?php echo base_url($crnt_view.'/view/'.$data['signoff_details_id'].'/'.$ypid);?>" class="btn btn-link"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                    <?php } ?>
                                    ...
                                    <a href="javascript:;" onclick="resendMail(<?php echo $data['signoff_details_id'] ; ?>,<?php echo $data['yp_id'] ; ?>,<?php echo $pp_id ; ?>);" class="btn btn-default width_a" title="Resend">Resend</a>
                                    <?php } } ?>

                                  <?php }else{ ?>
                                   <?php if (checkPermission('PlacementPlan', 'view')) { ?>
                                    <a href="<?php echo base_url($crnt_view.'/view/'.$data['signoff_details_id'].'/'.$ypid.'/'.$care_home_id.'/'.$past_care_id);?>" class="btn btn-link"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                    <?php } ?>
