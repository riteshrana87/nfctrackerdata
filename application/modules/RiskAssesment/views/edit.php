        ...
        <h1 class="page-title">
            ...
            <div class="pull-right for-tab">
                <div class="btn-group capsBtn">
                    <button type="submit" class="btn btn-default" name="submit_raform" id="submit_raform" value="submit" style="default">Update</button>
                    ...
                    <a href="<?=base_url($this->viewname .'/index/'.$ypid)?>" class="btn btn-default" style="default">Back To Ra</a>
                </div>
            </div>
        </h1>
        <h1 class="page-title">
            <small>Name: </small><?=!empty($YP_details[0]['yp_fname'])?$YP_details[0]['yp_fname']:''?> <?=!empty($YP_details[0]['yp_lname'])?$YP_details[0]['yp_lname']:''?><small>&nbsp;&nbsp;&nbsp;&nbsp;<div class="visible-xs-block"></div></small>
			<small>DOB:</small>  <?= (!empty($YP_details[0]['date_of_birth']) && $YP_details[0]['date_of_birth'] != '0000-00-00') ? configDateTime($YP_details[0]['date_of_birth']) : '' ?>
        </h1>
    </div>
        <div class="row">            
                <?php
                if(!empty($form_data))
                {
                    ...
                    <div class="col-sm-12 capsBtn">
                                <div class="">
                                <input type="hidden" name="risk_assesment_id" id="risk_assesment_id" value="<?=!empty($edit_data[0]['risk_assesment_id'])?$edit_data[0]['risk_assesment_id']:''?>">
                        <input type="hidden" name="yp_id" id="yp_id" value="<?=!empty($edit_data[0]['yp_id'])?$edit_data[0]['yp_id']:$ypid?>">
                        <input type="hidden" id="form_secret" name="form_secret"  value="<?php echo createFormToken();?>">
                                     <button type="submit" class="btn btn-default hidden-xs" name="submit_raform" id="submit_raform" value="submit" style="default">UPDATE</button>

                                     <div class="pull-right btn-section">
                                    <div class="btn-group">
                                        <button type="submit" class="btn btn-default visible-xs" name="submit_raform" id="submit_raform" value="submit" style="default">UPDATE</button>

                            <a href="<?=base_url($this->viewname .'/index/'.$ypid)?>" class="pull-right btn btn-default" style="default">Back To Ra</a>
                            <a href="<?=base_url('YoungPerson/view/'.$ypid)?>" class="pull-right btn btn-default" style="default">Back To YP Info</a>
                            <a href="<?=base_url('YoungPerson/index/'.$YP_details[0]['care_home'])?>" class="pull-right btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default"><i class="fa fa-mail-reply"></i> CARE HOME YP LIST</a>
