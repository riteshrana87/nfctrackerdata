                    ...
                    <?php foreach ($information as $data) { ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo base_url($crnt_view.'/external_view/'.$data['yp_id'].'/'.$data['ra_signoff_details_id']);?>" class="btn btn-link btn-blue"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                    <?php 
                                    ...
                                    <a href="javascript:;" onclick="resendMail(<?php echo $data['ra_signoff_details_id'] ; ?>,<?php echo $data['yp_id'] ; ?>);" class="btn btn-default width_a" title="Resend">Resend</a>
                                    <?php } } ?>
