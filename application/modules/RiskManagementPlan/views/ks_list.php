            ...
            <div class="pull-right for-tab">
                <div class="btn-group">
                    ...
                    /* condition added by Ritesh Rana on 03/10/2018 to archive functionaity */
                     if($past_care_id == 0){ ?>
                        <a href="<?=base_url('RiskManagementPlan/view/'.$rmp_id.'/'.$ypid); ?>" class="btn btn-default btn-xs-100">
                            <i class="fa fa-mail-reply"></i> Return To Current RMP
                        </a>
                        <a href="<?=base_url('YoungPerson/index/'.$YP_details[0]['care_home'])?>" class="btn btn-default btn-xs-100" name="submit_ppform" id="submit_ppform" value="submit" style="default"><i class="fa fa-mail-reply"></i> CARE HOME YP LIST</a>
                        <a href="<?=base_url('YoungPerson/view/'.$ypid); ?>" class="btn btn-default btn-xs-100">
                          <i class="fa fa-mail-reply"></i> YP INFO
                        </a>
                    <?php }else{ ?>
                        <a href="<?=base_url('RiskManagementPlan/view/'.$rmp_id.'/'.$ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default btn-xs-100">
                            <i class="fa fa-mail-reply"></i> Return To Current RMP
                        </a>
