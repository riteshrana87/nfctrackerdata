<div class="panel panel-default">
                    ...
                    foreach ($l2_form_data as $row) {
                        ...
                        if ($row['type'] == 'textarea') { ?>
                            ...
                            <?php }}else{ ?>
                                ...
                                <div class="panel-body" id="add_medical_observation">
                                    <?php if(!empty($l2medical_observations)){ 
                                        $med=1;
                                        foreach ($l2medical_observations as $key=>$value) { ?>
                                        <div class="row" id="item_new_medical_observation_<?php echo $med; ?>">
    <div class="col-sm-12">
    <div>
        <div class="panel-body">
            <div class="col-sm-3"><label>Medical observation taken</label></div>
            <div class="col-sm-9">
    ...
    <div>
                                            <div class="panel-body">
            <div class="col-sm-3"><label>Medical observations after xx minutes</label></div>
    ...
    <div>
                                            <div class="panel-body">
            <div class="col-sm-3"><label>Observation taken by</label></div>
            <div class="col-sm-9">
        ...
        <div>
            <div class="panel-body">
                <div class="col-sm-3"><label>Comments</label></div>
                <div class="col-sm-9">
    ...
    <div class="clearfix"></div>
            ...
            ?>
                            ...
                            <?php if ($row['name']=='l2_sanction_required'){ ?>
                                ...
                                <div class="panel-body" id="l2add_sequence_of_events">
                                    <?php if(!empty($l2sequence_events)){ 
                                        $se=1;
                                        foreach ($l2sequence_events as $key=>$value) { ?>
                                        <div class="row" id="l2item_new_sequence_<?php echo $se; ?>">
    <div class="col-sm-12">
    <div>
        <div class="panel-body">
    ...
    <div>
                                            <div class="panel-body">
            <div class="col-sm-3"><label>Who was involved in Incident </label></div>
            <div class="col-sm-9">
                
                                                    <?php $value_who = $value['l2Who_was_involved_in_incident'.$se];?>
                                                        <?php if(!empty($bambooNfcUsers)) {
                                                            foreach ($bambooNfcUsers as $select) {  
                    ...
                    <?php if(!empty($position_of_yp)) {
                        foreach ($position_of_yp as $select) { 
                            if(isset($value['l2position']) && ($value['l2position'] == $select['value'])){
                                    if (!empty($l2seqresult_prev)) {
                                        $diff = new HtmlDiff($l2seqresult_prev[$key]['l2position'],$value['l2position']);
                                        $diff->build();
                                        echo $diff->getDifference();
                                        ?>
                                     <?php } else { ?>
                                    ...
                                    <?php if(!empty($type)) {
                                        foreach ($type as $select) { 
                                            if(isset($value['l2type']) && ($value['l2type'] == $select['value'])){
                                                if (!empty($l2seqresult_prev)) {
                                                    $diff = new HtmlDiff($l2seqresult_prev[$key]['l2type'],$value['l2type']);
                                                    $diff->build();
                                                    echo $diff->getDifference();
                                            ?>
                                     <?php } else { ?>
