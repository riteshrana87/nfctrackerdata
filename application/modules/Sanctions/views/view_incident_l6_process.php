<div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingSix">
        <h4 class="panel-title">
            <a id="incident_l6_form_link" class="collapsed accordion-toggle text-uppercase" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                             ...
                             <?php if ($row['name']=='l6_sanction_required'){ ?>
                                ...
                                <div class="panel-body">
                                    <?php if(!empty($l6sequence_data)){ 
                                        ...
                                        <div class="row" id="item_new_sequence_six_<?php echo $ilsx; ?>">
    <div class="col-sm-12">
    <div>
        <div class="panel-body">
            ...
            <div class="col-sm-9">
                <?php if (!empty($l6sequence_data_prev)) {
                                        $diff = new HtmlDiff($l6sequence_data_prev[$key]['l6sequence_number'],$value['l6sequence_number']);
                                        $diff->build();
                                        echo $diff->getDifference();
                                        ?>
                                     <?php } else { ?>
                                            <?= !empty($value['l6sequence_number']) ? $value['l6sequence_number'] : '' ?>
                                     <?php } ?>
            </div> 
                                            </div>
                                        </div>
    ...
    <div>
        <div class="panel-body">
            <div class="col-sm-3"><label>Who raised Complaint</label></div>
            <div class="col-sm-9">
        ...
        <div>
                                            <div class="panel-body">
                <div class="col-sm-3"><label>What happened / what was done (include Senior Cover instructions)</label></div>
                        <div class="col-sm-9">
                            <?php if (!empty($l6sequence_data_prev)) {
