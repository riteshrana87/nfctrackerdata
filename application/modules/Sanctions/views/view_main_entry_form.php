                ...
                <div class="col-sm-12">
                    <div class="panel panel-default tile tile-profile">
                        <div class="panel-body form-margin"> 
                            ...
                            <div class="col-md-6 col-sm-12"> Type of incident </div>
                            <div class="col-md-6 col-sm-12" class="form-group">
                                <?php 
                                if($isCareIncident == 2){
                                    $checkEdu1 = 'checked';
                                    $checkCare2 = '';
                            ...
                            <?php } ?>
                            <div class="col-md-6 col-sm-12"> Is the incident related to any other recorded incident? </div>
                            <div class="col-md-6 col-sm-12" class="form-group">
                                <?php
