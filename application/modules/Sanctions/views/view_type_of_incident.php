                ...
                <div class="col-md-10">
                    <div class="panel panel-default tile tile-profile">
                        <div class="panel-body form-margin">                                                                    
                            ...
                            <div class="col-md-6 col-sm-12"> Was physical intervention used? </div>
                            ...
                            <div class="col-md-6 col-sm-12"> Did YP go missing? </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <?php
                                    if($is_yp_missing == 1){
                            ...
                            <div class="col-md-6 col-sm-12"> Was the YP injured? </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <?php
                                    if($is_yp_injured == 1){
                            ...
                            <div class="col-md-6 col-sm-12"> Has a complaint been made either by the YP or on behalf of the YP? </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <?php
                            ...
                            <div class="col-md-6 col-sm-12"> Is any part of this incident a safeguarding concern? </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <?php
                            ...
                            <div class="col-md-6 col-sm-12"> Was a staff member injured? </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <?php
                            ...
                            <div class="col-md-6 col-sm-12"> Was anyone else injured? </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <?php
