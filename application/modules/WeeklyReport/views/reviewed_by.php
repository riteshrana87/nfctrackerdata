...
<div id="page-wrapper">
    ...
    <div class="sticky-heading" id="sticky-heading">               
        <h1 class="page-title">
            WEEKLY REPORT <small>New Forest Care</small>
            <div class="pull-right for-tab">
                <div class="btn-group">
                    ...
                    <a href="<?= base_url('WeeklyReport/view/' . $weekly_report_id . '/' . $ypid); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Back to current WR
                    </a>
                    <?php }else{ ?>
                    ...
                    <a href="<?= base_url('WeeklyReport/view/' . $weekly_report_id . '/' . $ypid.'/'.$care_home_id.'/'.$past_care_id); ?>" class="btn btn-default">
                        <i class="fa fa-mail-reply"></i> Back to current WR
                    </a>  
                    <?php } ?>
                </div>
