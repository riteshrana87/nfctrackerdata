    ...
    <div class="col-xs-12 m-t-10">
        <div class="table-responsive">
            ...
            <td><?= !empty($data['care_home_name']) ? $data['care_home_name'] : lang('NA') ?></td>
                                ...
                                <a href="<?php echo base_url('ArchiveYoungPerson/undoArchive/'.$data['yp_id']);?>" class="btn btn-link btn-blue"><i class="fa fa fa-mail-reply" aria-hidden="true"></i></a></td>
                                <?php } ?>
    ...
    <div class="col-xs-12 m-t-10">
        ...
        <?php 
            ...
            <img src="<?= base_url() . $this->config->item('yp_care_home_img_upload_url') . $value['profile_img'] ?>" alt="" />
                ...
                <div class="careHomeDiv"><?= !empty($value['care_home_name']) ? $value['care_home_name'] : '' ?></div>
                </span>
            <?php }else{ ?>
             <span id="<?php echo $i; ?>" class="preview">
              <div class="disp-table-cell">
