...
function l4add_sequence_event() {
    ...
    html += '<div class="col-md-6 dynamic-div" id="item_new_' + countl4sq + '"><div class="form-group"><div class="col-md-6"><label>Sequence Number</label></div><div class="col-md-6"><input name="l4seq_sequence_number[]" value="S'+countl4sq+'" class="red form-control input-textar-style" type="text" /></div></div>';
    
    html += '<div class="form-group"><div class="col-md-6"><label>Who(staff full name)</label></div>';
    html += '<div class="col-md-6 ">';
    html += '<select data-parsley-errors-container="#errors-' + countl4sq + '" class="form-control chosen-select" id="' + countl4sq + '" name="l4seq_who' + countl4sq + '[]"><option value=""> Select user </option>';
    ...
    html+='<textarea id="what_happned" class="form-control input-textar-style"  placeholder="Attend Health appointments"  name="l4seq_what_happned[]"></textarea>';
    html+='</div></div>';
    ...
    html += '<input type="text" autocomplete="off" class="form-control sq_addtime_data timer-sty" required="true" name="l4seq_date_event[]" id="date_event" value="">';
    ...
    html+='<input type="text" class="red form-control l4_addtime_sequence addtime_data1 timer-sty" name="l4seq_time_event[]" id="l4time_event' + countl4sq + '" placeholder="" value="" data-parsley-errors-container="#errors-containertime_event" readonly="">';
    html+='<span class="input-group-addon add-on l4time_event' + countl4sq + '"><i class="fa fa-clock-o"></i></span>';
    html+='</div></div></div><div class="form-group"><div class="col-md-6">';
    html+='<label>All communication details</label></div>';
    html+='<div class="col-md-6"><textarea id="communication" class="form-control input-textar-style"  placeholder="All Communication Detail"  name="l4seq_communication[]"></textarea>';
    html+='</div></div>';
...
$('#send_worker_notification').click(function() {
    ...
    $.ajax({
        ...
        success: function (html) {
            $('#calculate_notification_worker').val(dt.getDate() + "/" + twoDigitMonth + "/" + dt.getFullYear() + ":" + dt.getHours() + ":" + dt.getMinutes() + ":" + dt.getSeconds());
            $.unblockUI();
            BootstrapDialog.show({
                title: 'Success',
...
$('#send_notification_missing_team').click(function() { 
    ...
    $.ajax({
        ...
        success: function(html) {
            $('#calculate_notification_missing').val(dt.getDate() + "/" + twoDigitMonth + "/" + dt.getFullYear() + ":" + dt.getHours() + ":" + dt.getMinutes() + ":" + dt.getSeconds());
            $.unblockUI();
            BootstrapDialog.show({
                title: 'Success',
                message: 'notification has been sent successfully',
...
function add_new_person_informed_yp_missing() {
    var html = '';
    html += '<div class=""></div>';
    html += '<div class="col-md-6 dynamic-div" id="item_new_' + count + '">';
    html += '<div class="form-group"><div class="col-md-6"><label>Persons Informed</label></div>';
    html += '<div class="col-md-6">';
    ...
    html += '<div class="col-md-6"><input name="name_of_person_informed_missing[]" class="red form-control input-textar-style" type="text" />';
    html += '</div></div>';
    html += '<div class="form-group"><div class="col-md-6"><label>Badge Number</label></div>';
    html += '<div class="col-md-6"><input class="red form-control input-textar-style" name="badge_number_person_missing[]" type="text" />';
    html += '</div></div>';
    html += '<div class="form-group"><div class="col-md-6"><label>Contact Number</label></div>';
    html += '<div class="col-md-6"><input class="red form-control input-textar-style" name="contact_number_person_missing[]" type="text" />';
    html += '</div></div>';
    html += '<div class="form-group"><div class="col-md-6"><label>Contact Email</label></div>';
    html += '<div class="col-md-6"><input class="red form-control input-textar-style" name="contact_email_person_missing[]" type="text" />';
    html += '</div></div>';
    html += '<div class="form-group"><div class="col-md-6"><label>Informed By</label></div>';
    html += '<div class="col-md-6"><input class="red form-control input-textar-style" name="informed_by_person_missing[]" type="text" />';
    html += '</div></div>';

    html += '<div class="form-group"><div class="col-md-6"><label>Date</label></div>';
    html += '<div class="col-md-6 m-t-3">';
    html += '<div class="input-group input-append">';
    html += '<input type="text" autocomplete="off" class="form-control seq_adddate seq_addtime_data timer-sty" required="true" name="date_event[]" id="date_event" value="">';
    ...
    html += '<div class="form-group"><div class="col-md-6"><label>Time</label></div>';
    html += '<div class="col-md-6 m-t-3"><div class="input-group input-append bootstrap-timepicker">';
    html += '<input type="text" class="red form-control  aaitime addtime_data1 timer-sty" name="time_event[]" id="l4persons_informed'+ count +'" placeholder="" value="" data-parsley-errors-container="#errors-containertime_event" readonly="">';
    html += '<span class="input-group-addon add-on l4persons_informed'+ count +'"><i class="fa fa-clock-o"></i></span></div></div></div>';
...
function add_new_person_informed_yp_return() {
    ...
    html += '</div></div>';
    html += '<div class="form-group"><div class="col-md-6"><label>Badge Number</label></div>';
    html += '<div class="col-md-6"><input class="red form-control input-textar-style" name="badge_number_person_return[]" type="text" />';
    ...
    html += '<div class="input-group input-append">';
    html += '<input type="text" autocomplete="off" class="form-control seq_addtime_data timer-sty" required="true" name="person_return_date_event[]" id="date_event" value="">';
    html += '<span class="input-group-addon add-on"><i class="fa fa-calendar"></i></span>';
    html += '</div><span id="errors-containerdate_of_disclosure"></span>';
    html += '</div>';
    html += '</div>';
    ...
    html += '<div class="form-group"><div class="col-md-6"><label>Time</label></div>';
    html += '<div class="col-md-6 m-t-3"><div class="input-group input-append bootstrap-timepicker">';
    html += '<input type="text" class="red form-control  l4_addtime_yp_return addtime_data1 timer-sty" name="person_return_time_event[]" id="return_time_event'+count_pr+'" placeholder="" value="" data-parsley-errors-container="#errors-containertime_event" readonly="">';
    html += '<span class="input-group-addon add-on return_time_event'+count_pr+'""><i class="fa fa-clock-o"></i></span></div></div></div>';
