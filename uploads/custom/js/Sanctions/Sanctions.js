    ...
    if (startDate !== '' && endDate !== '' && startTime !== '' && endTime !== '') {
        ...
        if (diffSeconds < 0) {
            ...
            if(startDate == endDate)
                $('#l1_conclude_time').timepicker('setTime', startTime);
            return false;
        }
...
//    alert('result is '+startDate + ' ' + endDate + ' ' + startTime + ' ' + endTime);
    if (startDate !== '' && endDate !== '' && startTime !== '' && endTime !== '') {
        ...
        if (diffSeconds < 0) {
            ...
            if(startDate == endDate)
                $('#l2_conclude_time').timepicker('setTime', startTime);
            return false;
        }
        var HH = Math.floor(diffSeconds / 3600);
        var MM = Math.floor(diffSeconds % 3600) / 60;
...
var html = '';
    ...
    html += '<div class="row" id="item_new_safeguarding_' + count_data + '">';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Sequence Number</label></div>';
    html += '<div class="col-sm-9"><input name="l7sequence_number[]" class="red form-control" type="text" /></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Update By</label></div>';
    ...
    html += '<div class="col-sm-12"><div ><div class="panel-body"><div class="col-sm-3"><label>Daily action taken</label></div>';
    html += '<div class="col-sm-9"><textarea id="what_happned" class="form-control"  placeholder="Daily action outcome"  name="l7daily_action_taken[]"></textarea></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Daily action outcome</label></div>';
    html += '<div class="col-sm-9"><textarea id="what_happned" class="form-control"  placeholder="Daily action outcome" name="l7daily_action_outcome[]"></textarea></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Supporting documents</label></div>';
    html += '<div class="col-sm-9"><input multiple="true" type="file" id="l7supporting_documents" class="form-control" placeholder="Daily action outcome" name="l7supporting_documents' + count_data + '[]" /></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Date</label></div>';
    html += '<div class="col-sm-9"><input class="form-control adddate addtime_data" name="l7date_safeguarding[]" id="safe_addtime_data" type="text" /></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Time</label></div>';
    html += '<div class="input-group input-append bootstrap-timepicker">';
    html += '<input type="text" class="red form-control addtime addtime_data1 time_safeguard" name="l7time_safeguard[]" id="time_safeguard" placeholder="" value="" data-parsley-errors-container="#errors-containertime_event" readonly="">';
    html += '<span class="input-group-addon add-on"><i class="fa fa-clock-o"></i></span></div></div></div></div>';
    html += '<div class="col-md-1 col-sm-2 add_items_field mb44"><a class="btn btn-default btn_border"><span class="glyphicon glyphicon-trash" onclick="delete_safeguard_row(\'item_new_safeguarding_' + count_data + '\');"></span></a></div><div class="clearfix"></div></div></div>';
    html += '</div>';
    html += '</div>';
    count_data++;
    return html;
...
$(function () {
    ...
    $('#add_new_safe_updates').click(function () {
        ...
        $('.time_safeguard').timepicker({defaultTime: '', minuteStep: 5});
...
function add_sequence_event()
{
    ...
    html += '<div class="row" id="item_new_' + count + '"><div class="col-sm-12"><div ><div class="panel-body"><div class="col-sm-3"><label>Sequence Number</label></div><div class="col-sm-9"><input name="sequence_number[]" class="red form-control" type="text" /></div></div></div></div><div class="col-sm-12"><div ><div class="panel-body"><div class="col-sm-3"><label>Who(staff full name)</label></div><div class="col-sm-9"><input class="red form-control" name="who[]"  type="text" /></div></div></div></div><div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>What Happned / what was done(include senior cover instruction)</label></div><div class="col-sm-9"><textarea id="what_happned" class="form-control"  placeholder="Attend Health appointments"  name[]="what_happned"></textarea></div></div></div></div><div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Date</label></div><div class="col-sm-9"><input class="form-control adddate addtime_data" name="date_event[]" id="date_event" type="text" /></div></div></div></div><div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Time</label></div><div class="input-group input-append bootstrap-timepicker"><input type="text" class="red form-control  addtime addtime_data1" name="time_event" id="time_event" placeholder="" value="" data-parsley-errors-container="#errors-containertime_event" readonly=""><span class="input-group-addon add-on time_event"><i class="fa fa-clock-o"></i></span></div></div></div></div><div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>What Happned / what was done(include senior cover instruction)</label></div><div class="col-sm-9"><textarea id="communication" class="form-control"  placeholder="All Communication Detail"  name="communication[]"></textarea></div></div></div></div><div class="col-md-1 col-sm-2 add_items_field mb44"><a class="btn btn-default btn_border"><span class="glyphicon glyphicon-trash" onclick="delete_cpt_review_row_health(\'item_new_' + count + '\');"></span></a></div><div class="clearfix"></div></div></div>';
...
$(function () {
    ...
    $('#add_new_seq_event').click(function () {
        ...
        $('#time_event').timepicker({defaultTime: '', minuteStep: 5});
...
var html = '';
    html += '<div class="clearfix"></div>';
    html += '<div class="row" id="l2item_new_sequence_' + l2_count_data + '">';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Sequence Number</label></div>';
    html += '<div class="col-sm-9"><input name="l2sequence_number[]" class="red form-control" type="text" /></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Who was involved in Incident</label></div>';
    html += '<div class="col-sm-9">';
    html += '<select multiple data-parsley-errors-container="#errors-'+ l2_count_data + '" class="form-control chosen-select" id="' + l2_count_data + '" name="l2Who_was_involved_in_incident' + l2_count_data + '[]"><option value=""> Select user </option>';
    ...
    html += '</select></div></div></div></div>';
    html += '<div class="col-sm-12"><div ><div class="panel-body"><div class="col-sm-3"><label>Position</label></div>';
    html += '<div class="col-sm-9">';
    html += '<select data-parsley-errors-container="#errors-'+ l2_count_data + '" class="form-control chosen-select" id="' + l2_count_data + '" name="l2position[]"><option value=""> Select user </option>';
            $.each(position_of_yp, function (i, elem) {
                console.log(elem);
                html += '<option value="'+elem['value']+'">'+ elem['label'] +'</option>';
            });
    html += '</select></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Type</label></div>';
    html += '<div class="col-sm-9">';
    html += '<select data-parsley-errors-container="#errors-'+ l2_count_data + '" class="form-control chosen-select" id="' + l2_count_data + '" name="l2type[]"><option value=""> Select user </option>';
            $.each(type, function (i, elem) {
                console.log(elem);
                html += '<option value="'+elem['value']+'">'+ elem['label'] +'</option>';
            });
    html += '</select></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Comments</label></div>';
    html += '<div class="col-sm-9"><textarea id="comments" class="form-control" placeholder="Comments"  name="l2comments[]"></textarea></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Time</label></div>';
    html += '<div class="input-group input-append bootstrap-timepicker">';
    html += '<input type="text" class="red form-control addtime addtime_data1 l2time_sequence" name="l2time_sequence[]" id="time_safeguard" placeholder="" value="" data-parsley-errors-container="#errors-containertime_event" readonly="">';
    html += '<span class="input-group-addon add-on"><i class="fa fa-clock-o"></i></span></div></div></div></div>';
    html += '<div class="col-md-1 col-sm-2 add_items_field mb44"><a class="btn btn-default btn_border"><span class="glyphicon glyphicon-trash" onclick="delete_sequence_row(\'l2item_new_sequence_' + l2_count_data + '\');"></span></a></div><div class="clearfix"></div></div></div>';
    html += '</div>';
    html += '</div>';
    l2_count_data++;
    return html;
...
$(function () {
    ...
    $('#l2add_new_sequence_of_events_updates').click(function () {
        ...
        $('.l2time_sequence').timepicker({defaultTime: '', minuteStep: 5});
...
var html = '';
    html += '<div class="clearfix"></div>';
    html += '<div class="row" id="item_new_medical_observation_' + l2_count_meds + '">';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Medical observation taken</label></div>';
    html += '<div class="col-sm-9"><div class="radio-group"><div class="radio-inline">';
    ...
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Medical observations after xx minutes</label></div>';
    html += '<div class="input-group input-append bootstrap-timepicker">';
    html += '<input type="text" class="red form-control addtime addtime_data1 l2time_sequence" name="l2medical_observations_after_minutes[]" id="time_safeguard" placeholder="" value="" data-parsley-errors-container="#errors-containertime_event" readonly="">';
    html += '<span class="input-group-addon add-on"><i class="fa fa-clock-o"></i></span></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Time</label></div>';
    html += '<div class="input-group input-append bootstrap-timepicker">';
    html += '<input type="text" class="red form-control addtime addtime_data1 l2time_sequence" name="l2time_medical[]" id="time_safeguard" placeholder="" value="" data-parsley-errors-container="#errors-containertime_event" readonly="">';
    html += '<span class="input-group-addon add-on"><i class="fa fa-clock-o"></i></span></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Observation taken by</label></div>';
    html += '<div class="col-sm-9">';
    ...
    html += '</select></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Comments</label></div>';
    html += '<div class="col-sm-9"><textarea id="comments" class="form-control" placeholder="Comments" name="l2comments_mo[]"></textarea></div></div></div></div>';
    html += '<div class="col-md-1 col-sm-2 add_items_field mb44"><a class="btn btn-default btn_border"><span class="glyphicon glyphicon-trash" onclick="delete_medical_observation(\'item_new_medical_observation_' + l2_count_meds + '\');"></span></a></div><div class="clearfix"></div></div></div>';
    html += '</div>';
    html += '</div>';
    l2_count_meds++;
    return html;
...
var html = '';
    html += '<div class="clearfix"></div>';
    html += '<div class="row" id="item_new_sequence_six_' + count_data_six + '">';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Sequence Number</label></div>';
    html += '<div class="col-sm-9"><input name="l6sequence_number[]" class="red form-control" type="text" /></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Who raised Complaint</label></div>';
    html += '<div class="col-sm-9">';
    html += '<select data-parsley-errors-container="#errors-'+ count_data_six + '" class="form-control chosen-select" id="' + count_data_six + '" name="l6who_raised_complaint[]"><option value=""> Select user </option>';
            $.each(bambooNfcUsers, function (i, elem) {
                console.log(elem);
                html += '<option value="'+elem['user_type']+'_'+elem['user_id']+'"> '+ elem['first_name'] +' '+ elem['last_name']+'-'+ elem['email'] +' </option>';
            });
    html += '</select></div></div></div></div>';
    html += '<div class="col-sm-12"><div ><div class="panel-body"><div class="col-sm-3"><label>What happened / what was done (include Senior Cover instructions)</label></div>';
    html += '<div class="col-sm-9"><textarea id="what_happned" class="form-control"  placeholder="Daily action outcome"  name="l6what_happened[]"></textarea></div></div></div></div>';
    
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Date</label></div>';
    html += '<div class="col-sm-9"><input class="form-control adddate addtime_data" name="l6sequence_date[]" id="safe_addtime_data" type="text" /></div></div></div></div>';
    html += '<div class="col-sm-12"><div><div class="panel-body"><div class="col-sm-3"><label>Time</label></div>';
    html += '<div class="input-group input-append bootstrap-timepicker">';
    html += '<input type="text" class="red form-control addtime addtime_data1 time_safeguard" name="l6time_sequence[]" id="time_safeguard" placeholder="" value="" data-parsley-errors-container="#errors-containertime_event" readonly="">';
    html += '<span class="input-group-addon add-on"><i class="fa fa-clock-o"></i></span></div></div></div></div>';
    html += '<div class="col-md-1 col-sm-2 add_items_field mb44"><a class="btn btn-default btn_border"><span class="glyphicon glyphicon-trash" onclick="delete_safeguard_row(\'item_new_sequence_six_' + count_data_six + '\');"></span></a></div><div class="clearfix"></div></div></div>';
    html += '</div>';
    html += '</div>';
    count_data++;
    return html;
