...
// generate Excel File script
	$('.export').click(function(e){
		...
		var url=baseurl +'Medical/generateExcelFile/'+ypid+'/print/?sortfield='+sortfield+'&sortby='+sortby+'&professional_name='+professional_name+'&search_date='+search_date+'&search_time='+search_time+'&search='+search;
		$(this).attr('href',url);
		$.ajax({
        type: "GET",
        url: url,
        data: {
            professional_name: professional_name,search_date : search_date,search_time : search_time,search:search,sortfield:sortfield,sortby:sortby
        },
...
//print script
	$('.print').click(function(e){
		...
		var click="window.open('"+url+"','_blank');return false";
		$(this).attr('href',url);
...
//get medical detail
if (typeof administer_medication_id !== "undefined") {
