    ...
    var z = function() {
        ...
        A = function() {
            var b = function(a, b) {
                ...
                m = function(a) {
                    var b = "<tr><td>âŒ˜ + B</td><td>" + a.font.bold + "</td></tr><tr><td>âŒ˜ + I</td><td>" + a.font.italic + "</td></tr><tr><td>âŒ˜ + U</td><td>" + a.font.underline + "</td></tr><tr><td>âŒ˜ + â‡§ + S</td><td>" + a.font.strikethrough + "</td></tr><tr><td>âŒ˜ + \\</td><td>" + a.font.clear + "</td></tr>";
                    return l(a.shortcut.textFormatting, b)
                },
                n = function(a) {
                    var b = "<tr><td>âŒ˜ + Z</td><td>" + a.history.undo + "</td></tr><tr><td>âŒ˜ + â‡§ + Z</td><td>" + a.history.redo + "</td></tr><tr><td>âŒ˜ + ]</td><td>" + a.paragraph.indent + "</td></tr><tr><td>âŒ˜ + [</td><td>" + a.paragraph.outdent + "</td></tr><tr><td>âŒ˜ + ENTER</td><td>" + a.hr.insert + "</td></tr>";
                    return l(a.shortcut.action, b)
                },
                o = function(a) {
                    var b = "<tr><td>âŒ˜ + â‡§ + L</td><td>" + a.paragraph.left + "</td></tr><tr><td>âŒ˜ + â‡§ + E</td><td>" + a.paragraph.center + "</td></tr><tr><td>âŒ˜ + â‡§ + R</td><td>" + a.paragraph.right + "</td></tr><tr><td>âŒ˜ + â‡§ + J</td><td>" + a.paragraph.justify + "</td></tr><tr><td>âŒ˜ + â‡§ + NUM7</td><td>" + a.lists.ordered + "</td></tr><tr><td>âŒ˜ + â‡§ + NUM8</td><td>" + a.lists.unordered + "</td></tr>";
                    return l(a.shortcut.paragraphFormatting, b)
                },
                p = function(a) {
                    var b = "<tr><td>âŒ˜ + NUM0</td><td>" + a.style.normal + "</td></tr><tr><td>âŒ˜ + NUM1</td><td>" + a.style.h1 + "</td></tr><tr><td>âŒ˜ + NUM2</td><td>" + a.style.h2 + "</td></tr><tr><td>âŒ˜ + NUM3</td><td>" + a.style.h3 + "</td></tr><tr><td>âŒ˜ + NUM4</td><td>" + a.style.h4 + "</td></tr><tr><td>âŒ˜ + NUM5</td><td>" + a.style.h5 + "</td></tr><tr><td>âŒ˜ + NUM6</td><td>" + a.style.h6 + "</td></tr>";
